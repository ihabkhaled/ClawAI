...
| 064 | [Session-bound user tokens](adr-064-session-bound-user-tokens.md)                 | Accepted                                  | Hashed refresh rotation, replay revocation, strict JWT claims, one-time sign-out            |
