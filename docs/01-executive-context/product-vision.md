...
> [ADR-126](../13-adr/adr-126-every-ai-one-workspace-positioning.md) (2026-09-26);
> the change of direction is [DRIFT-001](../02-business-product/drift-log.md).
> The flagship list, each traced to code, is
> [flagship-features.md](../02-business-product/flagship-features.md).
...
| **Pay as you go**           | Connector credit metered per use across every surface, shown in the visitor's own currency                                                                                                              | Flagship 9; numbers in [`docs/business/`](../business/README.md)                        |
...
Personas in detail: [user-personas.md](../02-business-product/user-personas.md).
...
2. **Every AI surface is metered, and every meter is honest.** Integer money,
   ...
   [rules/37](../../rules/37-payg-credit-integrity.md)).
...
([REQ-POS-005](../02-business-product/requirements-register.md#req-pos-005)).
...
Market detail: [competitive-analysis.md](competitive-analysis.md).
