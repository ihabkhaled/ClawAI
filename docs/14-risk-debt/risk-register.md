...
### SEC-005: Coding-agent organisation membership is not checked

| Aspect      | Detail                                                                                                                                                                                                                                                                                                                                          |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Description | `FleetController.listMembers`, `listDevices`, `addMember` and `SamlController.setMetadata` (`apps/claw-agent-service/src/modules/fleet/`) never check that the caller belongs to the organisation. A signed-in user who knows an organisation id can add a member to it, and one who knows a slug can set its SAML metadata.                    |
| Likelihood  | 3 (Possible -- ids are not secret once shared; no UI, API only)                                                                                                                                                                                                                                                                                 |
| Impact      | 4 (Major -- a self-added OWNER can then change the organisation's coding-agent policy)                                                                                                                                                                                                                                                          |
| Score       | 12 (High)                                                                                                                                                                                                                                                                                                                                       |
| Mitigation  | Fixed by `fix(agent): check organization membership on every fleet endpoint`: `OrganizationAccessService` checks membership and role in the service layer; outsiders get 404; only an OWNER grants OWNER. Production had 0 organisations, so nothing was exploited. [REQ-SEC-001](../02-business-product/requirements-register.md#req-sec-001). |
...
### BIZ-004: Positioning over-promises teams features

| Aspect      | Detail                                                                                                                                                                                                                                                                         |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Description | The 2026-09-26 positioning ("bring your team", [ADR-126](../13-adr/adr-126-every-ai-one-workspace-positioning.md)) invites business buyers to expect SSO and a shared team account; neither exists, and the Team plan's seeded description promises pooling that is not built. |
| Likelihood  | 3 (Possible)                                                                                                                                                                                                                                                                   |
| Impact      | 3 (Moderate -- refunds, churn, trust)                                                                                                                                                                                                                                          |
| Score       | 9 (Medium)                                                                                                                                                                                                                                                                     |
| Mitigation  | Copy bounded by the [flagship catalog](../02-business-product/flagship-features.md) gap table; REQ-POS-005 and REQ-POS-006 track the missing features.                                                                                                                         |
| Status      | Open                                                                                                                                                                                                                                                                           |
