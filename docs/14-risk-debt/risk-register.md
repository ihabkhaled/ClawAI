...
| Score       | 12 (High)                                                                                                                                                                                                                                                                                                                    |
| Mitigation  | Fixed in commit `cbe566511`: `OrganizationAccessService` checks membership and role in the service layer; outsiders get 404; only an OWNER grants OWNER. Production had 0 organisations, so nothing was exploited. [REQ-SEC-001](../02-business-product/requirements-register.md#req-sec-001).                               |
