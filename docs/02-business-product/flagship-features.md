...
> [product-vision.md](../01-executive-context/product-vision.md); why it changed is
> [ADR-126](../13-adr/adr-126-every-ai-one-workspace-positioning.md). The README,
...
The older, broader list is the [feature catalog](feature-catalog.md) (last
reviewed 2026-04-11) and the per-feature [feature inventory](feature-inventory.md).
...
Decisions: [ADR-120](../13-adr/adr-120-clawai-owns-multimodal-orchestration.md),
[ADR-122](../13-adr/adr-122-media-features-plan-gated-at-the-executing-service.md).
...
Decisions: [ADR-105](../13-adr/adr-105-answer-export-through-the-file-pipeline.md),
[ADR-107](../13-adr/adr-107-one-markdown-parser-typst-pdf.md),
[ADR-108](../13-adr/adr-108-spreadsheets-decks-and-bundles.md),
[ADR-109](../13-adr/adr-109-ai-names-its-files.md),
[ADR-110](../13-adr/adr-110-daily-ai-file-allowance.md),
[ADR-111](../13-adr/adr-111-file-writer-hardening-from-the-model-matrix.md).
...
Decisions: [ADR-104](../13-adr/adr-104-expiring-owner-only-file-downloads.md),
[ADR-114](../13-adr/adr-114-seven-zip-wasm-for-every-archive-format.md).
...
Decisions: [ADR-091](../13-adr/adr-091-user-urls-are-opened-not-searched.md),
[ADR-092](../13-adr/adr-092-site-crawl-reuses-fetchservice-no-new-fetch-path.md),
[ADR-098](../13-adr/adr-098-auto-research-is-an-ai-driven-narrated-loop.md),
[ADR-121](../13-adr/adr-121-pluggable-fetch-strategy-layer.md).
...
Decisions: [ADR-116](../13-adr/adr-116-comparative-judge-for-compare.md),
...
| Cross-thread context, on by default, own threads only                            | `useCrossThreadContext @default(true)` in the chat schema                          | Off per thread; [ADR-087](../13-adr/adr-087-cross-thread-retrieval.md) predates the default flip |
...
Gemini. [ADR-122](../13-adr/adr-122-media-features-plan-gated-at-the-executing-service.md).
...
Decision: [ADR-075](../13-adr/adr-075-public-share-assets.md).
...
Numbers: [`docs/business/`](../business/README.md). Decisions:
...
Decisions: [ADR-100](../13-adr/adr-100-router-candidates-and-per-model-context-fit.md),
[ADR-117](../13-adr/adr-117-connector-presets-one-registry-generic-adapter.md),
[ADR-124](../13-adr/adr-124-provider-key-credit-preflight-and-one-retry.md),
[ADR-125](../13-adr/adr-125-provider-refusals-recover-at-the-chokepoint.md).
...
See [Coding Agent](../../wiki/Coding-Agent.md).
...
Decision: [ADR-076](../13-adr/adr-076-chat-stream-durability.md).
