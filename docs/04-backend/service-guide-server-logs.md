...
## Container log ingestion (ADR-101, 2026-09-19)

| Method | Route                                   | Auth          | Purpose                                                                   |
| ------ | --------------------------------------- | ------------- | ------------------------------------------------------------------------- |
| POST   | `/api/v1/server-logs/ingest/containers` | Service token | Every container's stdout/stderr from `claw-log-shipper` (Vector), batched |
| POST   | `/api/v1/server-logs`                   | Service token | Was `@Public()`; reachable from the internet until this change            |
