# ClawAI — Mistral router

Compact router for Mistral. This file does not duplicate policy — it routes you
...
- Use the same canonical routing and safety rules as every other agent. When in
  doubt, resolve context first and read the governing rule before editing.
