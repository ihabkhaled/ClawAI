...
orchestration platform: 18 NestJS microservices + a Next.js frontend + 6 shared
...
- Events: 184 on `claw.events`
- Permissions: 84 · Env vars: 359
- API endpoints: 700 · Frontend pages: 155
