...
Compact router for Qwen. This file does not duplicate policy — it routes you
...
- Prefer small, responsibility-scoped changes; run `npm run affected:list` before
  editing to confirm scope. Never rewrite across many workspaces at once.
