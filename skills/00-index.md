...
| Add an OpenAI-compatible Provider        | `add-an-openai-compatible-provider.md`         | A new provider whose API is OpenAI-shaped (Groq, OpenRouter, Cerebras, etc.) — one `CONNECTOR_PRESETS` entry, no new adapter class (ADR-116).                                          |
