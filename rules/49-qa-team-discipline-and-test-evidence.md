...
· [rules/41](41-web-evidence-truthfulness.md) ·
...
This rule is about _proving the feature_; [rules/34](34-gate-economy-and-machine-resources.md)
...
- Lint / typecheck / test / build run **once, at the end, scoped** to what you
  touched ([rules/48](48-lint-and-test-only-what-changed.md)).
