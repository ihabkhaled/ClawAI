...
| Rule                                   | Mechanism                                                                                                                                                                                                                                                                          |
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 — surface enum member                | **Unit test** — `packages/shared-types/src/enums/__tests__/payg-surface-exhaustiveness.spec.ts` reads the real call sites and fails on a member no service emits, or a member with no user-facing ledger label. `payg-credit-surfaces.spec.ts` covers the per-surface behaviour.   |
