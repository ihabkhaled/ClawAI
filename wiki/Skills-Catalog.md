> **Wiki source:** [`skills/README.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/README.md) on the current `main` branch.
...
See [`./resolve-task-context.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/resolve-task-context.md) for the full flag
...
- **`rules/`** are non-negotiable constraints (see
  [`../rules/00-master-rules.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/00-master-rules.md)). Skills are the
...
- **Context docs** — `docs/` (esp. [`../docs/15-ai-context/`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/15-ai-context)
  and [`../docs/03-architecture/`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture)) are the ground
...
| [`trace-event-end-to-end.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/trace-event-end-to-end.md)           | Trace a RabbitMQ event publisher → `claw.events` → consumer               |
| [`trace-frontend-feature.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/trace-frontend-feature.md)           | Trace page.tsx → controller hook → hooks/queries → repository             |
| [`find-canonical-owner.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/find-canonical-owner.md)               | Which service/package owns a concept; where a util belongs                |
| [`inspect-affected-workspaces.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/inspect-affected-workspaces.md) | `affected:list` + variants; per-touched-folder gate scoping               |

### Wiring (mutating runbooks)

- [`add-a-shared-package-to-a-service.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/add-a-shared-package-to-a-service.md) —
...
- [`run-the-qa-team.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/run-the-qa-team.md) — every QA hat over one change:
  ...
  companion [`verify-a-batch-live.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/verify-a-batch-live.md) carries the
...
- [`00-index.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/00-index.md)
- [`01-codebase-navigation.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/01-codebase-navigation.md)
- [`02-service-scaffold.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/02-service-scaffold.md)
- [`03-feature-scaffold.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/03-feature-scaffold.md)
- [`04-debug-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/04-debug-toolkit.md)
- [`05-qa-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/05-qa-toolkit.md)
- [`06-docker-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/06-docker-toolkit.md)
- [`07-database-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/07-database-toolkit.md)
- [`08-event-bus-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/08-event-bus-toolkit.md)
- [`09-refactor-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/09-refactor-toolkit.md)

### Billing and scheduled operations

- [`reconcile-billing-state.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/reconcile-billing-state.md)
- [`debug-a-stuck-scheduled-job.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/debug-a-stuck-scheduled-job.md)
- [`add-a-payment-gateway-flow.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/add-a-payment-gateway-flow.md)
- [`meter-a-paid-provider-call.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/meter-a-paid-provider-call.md)
- [`deploy-payg-credit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/deploy-payg-credit.md)
