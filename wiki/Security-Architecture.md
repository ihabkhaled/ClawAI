> **Wiki source:** [`docs/03-architecture/security-architecture.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/security-architecture.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
