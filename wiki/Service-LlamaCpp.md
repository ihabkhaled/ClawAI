> **Canonical source:** `docs/04-backend/service-guide-llamacpp.md`
...
| File                                                                                            | Responsibility                                                                                                                  |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [src/main.ts](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/main.ts)                                     | NestJS bootstrap (helmet, CORS, RabbitMQ logger, prefix `/api/v1`)                                                              |
| [src/app/app.module.ts](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/app/app.module.ts)                 | Root module — wires Binary, Catalog, Hardware, PullJobs, ModelsLifecycle, Inference, Health                                     |
| [src/app/config/app.config.ts](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/app/config/app.config.ts)   | Zod-validated `AppConfig` with all `LLAMACPP_*` env vars                                                                        |
| [src/modules/binary/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/binary)                     | `BinaryService` + `BinaryInstallerManager` — pinned llama.cpp release                                                           |
| [src/modules/catalog/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/catalog)                   | `CatalogService` + `CatalogRefreshManager` — 9 seed entries + HF refresh                                                        |
| [src/modules/pull-jobs/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/pull-jobs)               | `PullJobsService` + `PullJobRunnerManager` + `PullJobProgressEmitterManager` (SSE)                                              |
| [src/modules/models-lifecycle/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/models-lifecycle) | `ModelsLifecycleService` + `LlamaServerLauncherManager` + `ProcessSupervisorManager`                                            |
| [src/modules/inference/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/inference)               | `InferenceService` + `InferenceProxyManager` (OpenAI-compatible passthrough)                                                    |
| [src/modules/hardware/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/hardware)                 | `HardwareService` + `HardwareDetectorManager` + `PreflightValidatorManager`                                                     |
| [src/modules/health/](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/src/modules/health)                     | `HealthService` — rolls up DB + binary + active model                                                                           |
| [prisma/schema.prisma](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/prisma/schema.prisma)                   | 7 models: FrontierCatalogEntry, PullJob, ModelLoadEvent, RuntimeConfig, HardwareSnapshot, BinaryRelease, PreflightOverrideAudit |
| [prisma/seed-catalog.ts](https://github.com/ihabkhaled/ClawAI/blob/main/apps/claw-llamacpp-service/prisma/seed-catalog.ts)               | 9 seed entries: Kimi K2.6, Kimi K2-Thinking, GLM-5.1, DeepSeek V3.2/V4                                                          |
...
See [docs/11-runbooks/frontier-troubleshooting.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/11-runbooks/frontier-troubleshooting.md) for symptom-driven recovery procedures (download stuck, model won't load, model crashed, antivirus quarantine, etc.).
...
(See [docs/13-adr/](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr) for full text.)
