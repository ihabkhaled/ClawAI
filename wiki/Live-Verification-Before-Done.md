> **Canonical source:** `rules/44-live-verification-before-done.md`
...
**Related**: [rules/49](https://github.com/ihabkhaled/ClawAI/blob/main/rules/49-qa-team-discipline-and-test-evidence.md) ·
...
[rules/03](https://github.com/ihabkhaled/ClawAI/blob/main/rules/03-frontend-rules.md) ·
...
[rules/49](https://github.com/ihabkhaled/ClawAI/blob/main/rules/49-qa-team-discipline-and-test-evidence.md) says **who you must be**
...
3. **A `NEXT_PUBLIC_*` or shared-package change** needs a rebuild, not a restart.
   ...
   `service:rebuild` — see [`skills/06-docker-toolkit.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/06-docker-toolkit.md).
...
Runbook: [skills/verify-a-batch-live.md](https://github.com/ihabkhaled/ClawAI/blob/main/skills/verify-a-batch-live.md)
