> **Canonical source:** `docs/04-backend/service-guide-routing.md`
...
`POST /routing/replay` -- see [API Reference](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/api-reference-routing.md) for full request/response schema.
