> **Wiki source:** [`docs/14-risk-debt/risk-register.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/risk-register.md) on the current `main` branch.
