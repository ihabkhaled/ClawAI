> **Wiki source:** [`docs/08-runtime-devops/cicd-pipeline.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/08-runtime-devops/cicd-pipeline.md) on the current `main` branch.
...
[ADR-061](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-061-git-hook-policy-no-bypass.md). The pre-commit
