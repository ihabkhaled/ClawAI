> **Wiki source:** [`docs/04-backend/coding-standards.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/coding-standards.md) on the current `main` branch.
