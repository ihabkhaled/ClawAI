> **Canonical source:** `rules/23-git-commits-hooks-and-release-gates.md`
...
2. **Green then commit.** When touched-folder gates pass, commit and let the
   ...
   **`--no-verify` is banned** ([ADR-061](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-061-git-hook-policy-no-bypass.md));
...
- [commit-and-push-each-change](https://github.com/ihabkhaled/ClawAI/blob/main/skills/commit-and-push-each-change.md)
- [09-refactor-toolkit](https://github.com/ihabkhaled/ClawAI/blob/main/skills/09-refactor-toolkit.md)
