> **Wiki source:** [`ihabkhaled/ClawAI/testing/coverage-policy.md`](https://github.com/ihabkhaled/ClawAI/blob/main/testing/coverage-policy.md) on the current `main` branch.
...
- Coverage is **ratcheted, never lowered.** If a change drops a folder below its
  ...
  change ([`../memory/testing-strategy.md`](https://github.com/ihabkhaled/ClawAI/blob/main/memory/testing-strategy.md)).
...
([testing-strategy](https://github.com/ihabkhaled/ClawAI/blob/main/testing/testing-strategy.md)) and reject the fixed-count-quota anti-pattern.
...
([quality-gates](https://github.com/ihabkhaled/ClawAI/blob/main/testing/quality-gates.md)) and in full at `npm run release:preflight`. New code
in a change should not drop the workspace's existing coverage.

## Related

- [Quality gates](https://github.com/ihabkhaled/ClawAI/blob/main/testing/quality-gates.md) · [Unit testing](https://github.com/ihabkhaled/ClawAI/blob/main/testing/unit-testing-standard.md) ·
  ADR-063 coverage-targets · [`../memory/testing-strategy.md`](https://github.com/ihabkhaled/ClawAI/blob/main/memory/testing-strategy.md)
