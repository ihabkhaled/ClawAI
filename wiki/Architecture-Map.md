> **Wiki source:** [`ihabkhaled/ClawAI/context/architecture-map.md`](https://github.com/ihabkhaled/ClawAI/blob/main/context/architecture-map.md) on the current `main` branch.
...
**ClamAV** for upload scanning. See [service-catalog.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/service-catalog.md) and
...
[port-and-service-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/port-and-service-map.md).
...
[request-flow-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/request-flow-map.md).
...
never swallow errors silently. See [event-flow-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/event-flow-map.md).
...
[database-ownership-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/database-ownership-map.md) and
...
Full rules in [backend-architecture.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/backend-architecture.md) and
`rules/02-backend-rules.md`. Declaration placement (no inline
types/enums/consts) is in
[declaration-ownership-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/declaration-ownership-map.md).
...
Full rules in [frontend-architecture.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/frontend-architecture.md) and
...
[package-boundaries.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/package-boundaries.md).
...
[stack-and-toolchain.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/stack-and-toolchain.md).
