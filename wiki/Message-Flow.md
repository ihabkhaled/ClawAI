> **Wiki source:** [`docs/03-architecture/message-flow.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/message-flow.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
...
3. Execute the appropriate routing strategy (see [Routing Engine](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/routing-engine.md))
