> **Wiki source:** [`docs/10-uat-acceptance/business-acceptance.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/10-uat-acceptance/business-acceptance.md) on the current `main` branch.
