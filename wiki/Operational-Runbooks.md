> **Wiki source:** [`docs/11-runbooks/operational-runbooks.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/11-runbooks/operational-runbooks.md) on the current `main` branch.
