> **Wiki source:** `docs/03-architecture/model-catalog-architecture.md` on `main`. Generated for the repository Wiki; source links point back to the code repository.
...
> | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> | The models a user can pick in chat (cloud + local) | `ConnectorModel` in connector-service — [service-guide-connector](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/service-guide-connector.md)                                                   |
