> **Canonical source:** `docs/04-backend/service-guide-auth.md`
...
Full rule: [`rules/35-super-administrator-and-privilege-boundaries.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/35-super-administrator-and-privilege-boundaries.md) ·
Decision: [ADR-073](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-073-super-administrator-authority.md)
...
ordering, read [ADR-096](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-096-login-failure-taxonomy-without-account-enumeration.md)
...
Runbook: [skills/change-a-transactional-email.md](https://github.com/ihabkhaled/ClawAI/blob/main/skills/change-a-transactional-email.md) ·
Rule: [rules/43](https://github.com/ihabkhaled/ClawAI/blob/main/rules/43-account-state-disclosure-and-transactional-email.md)
...
[ADR-074](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-074-plan-signup-flag-and-popular-badge.md).
