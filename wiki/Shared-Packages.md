> **Wiki source:** [`docs/04-backend/shared-packages.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/shared-packages.md) on the current `main` branch.
