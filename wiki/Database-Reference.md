> **Wiki source:** [`docs/06-data/database-reference.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/06-data/database-reference.md) on the current `main` branch.
