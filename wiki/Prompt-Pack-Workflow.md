> **Canonical source:** `docs/15-ai-context/prompt-pack-intake-protocol.md`
...
- **Canonical policy**: [`rules/26-prompt-pack-intake-protocol.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/26-prompt-pack-intake-protocol.md)
- **Runbook**: [`skills/execute-prompt-pack.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/execute-prompt-pack.md)
- **Summary**: [`context/prompt-pack-intake.md`](https://github.com/ihabkhaled/ClawAI/blob/main/context/prompt-pack-intake.md)
...
[ADR-055](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-055-canonical-ai-authority-hierarchy.md) for the hierarchy and
[ADR-058](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-058-compact-ai-routers-not-mirrors.md) for why the per-tool
