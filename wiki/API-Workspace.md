> **Wiki source:** [`docs/12-reference/api-reference-workspace.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/api-reference-workspace.md) on the current `main` branch.
...
[`service-guide-workspace.md`: USER VIEW + CONNECT Permission Scope](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/service-guide-workspace.md#user-view--connect-permission-scope-2026-05-30)
