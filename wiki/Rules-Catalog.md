> **Wiki source:** [`rules/README.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/README.md) on the current `main` branch.
...
Do not skim. Read [`00-non-negotiable-rules.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/00-non-negotiable-rules.md)
...
5. **Numbered `rules/*.md`** (this catalog, `01`–`40`).
...
> and is not superseded; this numbered `00-40` catalog is the finer-grained,
> enforcement-tagged expansion that lives alongside it. The full one-line index
> of every numbered file lives in [`00-master-rules.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/00-master-rules.md).
