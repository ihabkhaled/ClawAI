> **Wiki source:** [`docs/12-reference/api-reference-health.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/api-reference-health.md) on the current `main` branch.
