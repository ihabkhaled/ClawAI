> **Wiki source:** [`docs/12-reference/error-catalog.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/error-catalog.md) on the current `main` branch.
