> **Wiki source:** [`ihabkhaled/ClawAI/docs/15-ai-context/codebase-navigation.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/15-ai-context/codebase-navigation.md) on the current `main` branch.
