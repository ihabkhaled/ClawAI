> **Wiki source:** [`docs/SECURITY_HARDENING_ARCHITECTURE.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/SECURITY_HARDENING_ARCHITECTURE.md) on the current `main` branch.
