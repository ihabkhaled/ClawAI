> **Wiki source:** [`docs/10-uat-acceptance/uat-guide.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/10-uat-acceptance/uat-guide.md) on the current `main` branch.
