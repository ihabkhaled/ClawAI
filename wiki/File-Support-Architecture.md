> **Wiki source:** [`docs/FILE_SUPPORT_ARCHITECTURE.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/FILE_SUPPORT_ARCHITECTURE.md) on the current `main` branch.
