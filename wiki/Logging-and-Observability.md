> **Wiki source:** [`docs/LOGGING_OBSERVABILITY_ARCHITECTURE.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/LOGGING_OBSERVABILITY_ARCHITECTURE.md) on the current `main` branch.
