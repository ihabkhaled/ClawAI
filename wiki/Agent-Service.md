> **Wiki source:** [`docs/04-backend/service-guide-agent.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/service-guide-agent.md) on the current `main` branch.
