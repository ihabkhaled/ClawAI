> **Wiki source:** [`docs/11-runbooks/troubleshooting.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/11-runbooks/troubleshooting.md) on the current `main` branch.
