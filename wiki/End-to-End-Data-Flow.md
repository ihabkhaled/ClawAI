> **Wiki source:** [`docs/03-architecture/end-to-end-data-flow.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/end-to-end-data-flow.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
...
[../11-runbooks/runbook-service-crash.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/11-runbooks/runbook-service-crash.md)
and the SSE/error-handling lessons in the root [../../CLAUDE.md](https://github.com/ihabkhaled/ClawAI/blob/main/CLAUDE.md).
...
(see [../02-business-product/](https://github.com/ihabkhaled/ClawAI/blob/main/docs/02-business-product)).
...
- [event-bus.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/event-bus.md) — full event catalog (producers/consumers)
- [message-flow.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/message-flow.md) — message-flow deep dive (if present)
- [routing-engine.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/routing-engine.md) — the 5-stage routing pipeline
- [../08-runtime-devops/port-service-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/08-runtime-devops/port-service-map.md)
