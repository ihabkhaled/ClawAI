> **Canonical source:** `docs/14-ai-native-development/how-context-resolution-works.md`
...
then open the cited sources. ADR: [adr-057](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-057-deterministic-context-resolver.md).
