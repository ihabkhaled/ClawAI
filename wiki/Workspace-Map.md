> **Wiki source:** [`ihabkhaled/ClawAI/context/workspace-map.md`](https://github.com/ihabkhaled/ClawAI/blob/main/context/workspace-map.md) on the current `main` branch.
...
Full ownership rules: [package-boundaries.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/package-boundaries.md). Dependency
...
[testing-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/testing-map.md).
...
See [service-dependency-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/service-dependency-map.md) for the full edge set.
