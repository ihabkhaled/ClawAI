> **Wiki source:** [`ihabkhaled/ClawAI/context/stack-and-toolchain.md`](https://github.com/ihabkhaled/ClawAI/blob/main/context/stack-and-toolchain.md) on the current `main` branch.
...
entrypoint). See [database-ownership-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/database-ownership-map.md).
