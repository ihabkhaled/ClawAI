> **Wiki source:** [`docs/12-reference/api-reference-agent.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/api-reference-agent.md) on the current `main` branch.
