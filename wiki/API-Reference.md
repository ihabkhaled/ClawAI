> **Wiki source:** [`docs/12-reference/api-reference.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/api-reference.md) on the current `main` branch.
...
See [Judge & Critic Spec](https://github.com/ihabkhaled/ClawAI/blob/main/docs/02-business-product/judge-referee-spec.md) for
