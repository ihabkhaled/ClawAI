> **Wiki source:** [`docs/03-architecture/routing-engine.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/routing-engine.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
...
The router education layer extends this engine with bounded feedback learning from thumbs signals, judge outcomes, execution outcomes, fallback behavior, and replay telemetry. That layer is documented in [router-education-feedback-learning.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/router-education-feedback-learning.md).
...
See [Auto Re-Routing Spec](https://github.com/ihabkhaled/ClawAI/blob/main/docs/02-business-product/auto-rerouting-spec.md) for full details.
