> **Wiki source:** [`docs/RELEASE_READINESS_SCORECARD.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/RELEASE_READINESS_SCORECARD.md) on the current `main` branch.
...
| 3   | Backend Completeness  | **8/10** | All 17 services operational. Context assembly, memory extraction, connector management, routing policies all wired. Real business logic, not stubs.                                                       |
