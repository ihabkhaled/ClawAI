> **Wiki source:** [`ihabkhaled/ClawAI/context/environment-ownership-map.md`](https://github.com/ihabkhaled/ClawAI/blob/main/context/environment-ownership-map.md) on the current `main` branch.
...
- Adding a var that a compose file misses causes "container not found" / missing
  config at boot. The infra pack ([task-router.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/task-router.md)) covers this.
