> **Wiki source:** [`docs/08-runtime-devops/docker-guide.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/08-runtime-devops/docker-guide.md) on the current `main` branch.
...
gap; see [rule 14 §6](https://github.com/ihabkhaled/ClawAI/blob/main/rules/14-shared-packages.md) and
[add-a-shared-package-to-a-service](https://github.com/ihabkhaled/ClawAI/blob/main/skills/add-a-shared-package-to-a-service.md).
