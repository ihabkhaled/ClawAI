> **Wiki source:** [`docs/00-start-here/system-at-a-glance.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/00-start-here/system-at-a-glance.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
