> **Wiki source:** [`docs/03-architecture/system-architecture.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/system-architecture.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
...
See [Message Flow](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/message-flow.md) for the complete end-to-end sequence.

---

## Security Architecture

See [Security Architecture](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/security-architecture.md) for the full security documentation.
