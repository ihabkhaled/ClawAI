> **Wiki source:** [`docs/05-frontend/coding-standards.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/05-frontend/coding-standards.md) on the current `main` branch.
