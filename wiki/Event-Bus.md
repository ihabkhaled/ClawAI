> **Wiki source:** [`docs/03-architecture/event-bus.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/event-bus.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
...
Published after a router model-knowledge sync run finishes. See [routing-model-sync.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/routing-model-sync.md).
