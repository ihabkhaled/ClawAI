> **Wiki source:** [`docs/FORWARD_DEVELOPMENT_PLAN.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/FORWARD_DEVELOPMENT_PLAN.md) on the current `main` branch.
...
7. **i18n**: 9 languages with RTL — unusual for an AI platform
