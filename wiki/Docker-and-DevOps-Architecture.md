> **Wiki source:** [`docs/DOCKER_DEVOPS_ARCHITECTURE.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/DOCKER_DEVOPS_ARCHITECTURE.md) on the current `main` branch.
