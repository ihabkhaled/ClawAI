> **Wiki source:** [`ihabkhaled/ClawAI/docs/15-ai-context/ai-context-pack.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/15-ai-context/ai-context-pack.md) on the current `main` branch.
