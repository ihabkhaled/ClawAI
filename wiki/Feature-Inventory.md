> **Wiki source:** [`docs/02-business-product/feature-inventory.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/02-business-product/feature-inventory.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
