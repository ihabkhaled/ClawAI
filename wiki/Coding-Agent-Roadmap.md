> **Wiki source:** [`ihabkhaled/ClawAI-Coding-Agent/docs/ROADMAP.md`](https://github.com/ihabkhaled/ClawAI-Coding-Agent/blob/main/docs/ROADMAP.md) on the current `main` branch.
