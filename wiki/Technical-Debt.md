> **Wiki source:** [`docs/14-risk-debt/technical-debt.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/technical-debt.md) on the current `main` branch.
...
> [`technical-debt-register.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/technical-debt-register.md) both enumerate
...
- **Why it matters now**: until 2026-09-11 every URL the fetcher saw came from a
  ...
  ([ADR-091](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-091-user-urls-are-opened-not-searched.md)), and the
...
- **Rule**: [`rules/41-web-evidence-truthfulness.md`](https://github.com/ihabkhaled/ClawAI/blob/main/rules/41-web-evidence-truthfulness.md) §11.
...
- **Do not re-derive the causes.** They are enumerated with file and line in the
  ...
  - [`chat-pipeline-audit-2026-09.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/chat-pipeline-audit-2026-09.md)
  - [`chat-pipeline-baseline-2026-09.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/chat-pipeline-baseline-2026-09.md)
  - [`chat-pipeline-slos-2026-09.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/chat-pipeline-slos-2026-09.md) — the objectives derived from the above, each with the guard that catches a regression
...
- **Progress**: B2/B3/B4/B7 landed 2026-09-10 — the 2-second full-thread poll,
  ...
  ([ADR-089](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-089-client-telemetry-batch-endpoint.md)); C4's
...
- **Full entry**: [`technical-debt-register.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/14-risk-debt/technical-debt-register.md) TD-030.
