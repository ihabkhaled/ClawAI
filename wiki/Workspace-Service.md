> **Wiki source:** [`docs/04-backend/service-guide-workspace.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/service-guide-workspace.md) on the current `main` branch.
...
See also: [Authorization & RBAC — Workspace partial-relax permission pattern](https://github.com/ihabkhaled/ClawAI/blob/main/docs/03-architecture/authorization-rbac.md#workspace-partial-relax-permission-pattern).

---

## Related Docs

- [Services Index](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/services-index.md)
- [Inter-Service Communication](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/inter-service-communication.md)
- [API Reference](https://github.com/ihabkhaled/ClawAI/blob/main/docs/12-reference/api-reference.md)
