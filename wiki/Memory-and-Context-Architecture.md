> **Wiki source:** [`docs/MEMORY_CONTEXT_ARCHITECTURE.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/MEMORY_CONTEXT_ARCHITECTURE.md) on the current `main` branch.
