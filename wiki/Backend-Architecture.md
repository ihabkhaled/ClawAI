> **Wiki source:** [`docs/BACKEND_ARCHITECTURE.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/BACKEND_ARCHITECTURE.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
