> **Wiki source:** [`docs/00-start-here/onboarding-5-minutes.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/00-start-here/onboarding-5-minutes.md) on the current `main` branch. This page mirrors the repository documentation so the Wiki stays grounded in the codebase.
...
- [System at a Glance](https://github.com/ihabkhaled/ClawAI/blob/main/docs/00-start-here/system-at-a-glance.md) -- full architecture overview
