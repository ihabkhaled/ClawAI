> **Canonical source:** `docs/08-runtime-devops/port-service-map.md`
...
and is a CI matrix entry. See [../04-backend/shared-packages.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/04-backend/shared-packages.md).

## Where these are defined

- **Ports/names:** `packages/shared-constants/src/index.ts`
- **Inter-service URLs + DB URLs:** `.env` / [../06-data/environment-variables.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/06-data/environment-variables.md)
