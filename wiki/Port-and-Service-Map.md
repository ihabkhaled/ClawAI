> **Wiki source:** [`ihabkhaled/ClawAI/context/port-and-service-map.md`](https://github.com/ihabkhaled/ClawAI/blob/main/context/port-and-service-map.md) on the current `main` branch.
...
- Full gateway route table → [request-flow-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/request-flow-map.md) and
  `.ai/manifests/nginx-routes.json`.
- DB ownership per port → [database-ownership-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/database-ownership-map.md).
- Port env vars and propagation → [environment-ownership-map.md](https://github.com/ihabkhaled/ClawAI/blob/main/context/environment-ownership-map.md).
