> **Wiki source:** [`docs/06-data/environment-variables.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/06-data/environment-variables.md) on the current `main` branch.
...
[PRODUCTION_DEPLOYMENT.md](https://github.com/ihabkhaled/ClawAI/blob/main/docs/PRODUCTION_DEPLOYMENT.md) §2.8.
