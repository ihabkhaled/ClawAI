> **Wiki source:** [`docs/07-integrations/provider-catalog.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/07-integrations/provider-catalog.md) on the current `main` branch.
