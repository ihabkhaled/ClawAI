> **Canonical source:** `docs/05-frontend/seo-content-architecture.md`
...
Companion to [`multilingual-discovery.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/05-frontend/multilingual-discovery.md), which
