> **Wiki source:** [`docs/FULL_LIFECYCLE_AUDIT.md`](https://github.com/ihabkhaled/ClawAI/blob/main/docs/FULL_LIFECYCLE_AUDIT.md) on the current `main` branch.
...
| i18n (9 languages) | MEDIUM — international     | HIGH for target  | 9/10     | Low                                 |
...
| ------------------ | ------------------------ | --------------------------------------------------------- |
| Unit tests         | 312 across 17 services   | Add 2 untested services (logs)                            |
