> **Canonical source:** `docs/05-frontend/chat-surface-layout.md`
...
[ADR-088](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-088-composer-auto-height-replaces-drag-resize.md).
...
[ADR-090](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-090-model-picker-opens-at-the-current-choice.md).
...
[rules/03 §7](https://github.com/ihabkhaled/ClawAI/blob/main/rules/03-frontend-rules.md) normally forbids: a width test
...
[rules/40 §15](https://github.com/ihabkhaled/ClawAI/blob/main/rules/40-chat-surface-layout-and-composer.md) and
[ADR-090](https://github.com/ihabkhaled/ClawAI/blob/main/docs/13-adr/adr-090-model-picker-opens-at-the-current-choice.md).
...
- No `position: fixed` composer, therefore no clearance custom property to keep
  in step (see [rule 36](https://github.com/ihabkhaled/ClawAI/blob/main/rules/36-floating-ui-and-toast-clearance.md)).
- No second autosize implementation.
- No duplicated mobile/desktop control rows.

## See also

- [`skills/verify-responsive-layout-in-browser.md`](https://github.com/ihabkhaled/ClawAI/blob/main/skills/verify-responsive-layout-in-browser.md) — how to check the above in a real browser
