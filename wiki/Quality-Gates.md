> **Wiki source:** [`ihabkhaled/ClawAI/testing/quality-gates.md`](https://github.com/ihabkhaled/ClawAI/blob/main/testing/quality-gates.md) on the current `main` branch.
...
[coverage-policy.md](https://github.com/ihabkhaled/ClawAI/blob/main/testing/coverage-policy.md) for the coverage bar and
[../rules/22-testing-and-coverage.md](https://github.com/ihabkhaled/ClawAI/blob/main/rules/22-testing-and-coverage.md) for
...
[`tools/release/preflight.mjs`](https://github.com/ihabkhaled/ClawAI/blob/main/tools/release/preflight.mjs). This is the
