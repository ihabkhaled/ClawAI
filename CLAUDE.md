...
| A model says it cannot read an attached file                    | [`rules/42-attachment-understanding.md`](rules/42-attachment-understanding.md) · [`skills/debug-an-attachment-the-model-cannot-read.md`](skills/debug-an-attachment-the-model-cannot-read.md) · [ADR-093](docs/13-adr/adr-093-attachment-text-extraction-pipeline.md) |
