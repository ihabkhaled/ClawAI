...
| A model says it cannot read an attached file                    | [`rules/42-attachment-understanding.md`](rules/42-attachment-understanding.md) · [`skills/debug-an-attachment-the-model-cannot-read.md`](skills/debug-an-attachment-the-model-cannot-read.md) · [ADR-094](docs/13-adr/adr-094-attachment-text-extraction-pipeline.md) |
