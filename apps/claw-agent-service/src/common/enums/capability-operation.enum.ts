// Mirrors prisma/schema.prisma CapabilityOperation.
// Per-class subsets of these values are used; the enum is unified for
// schema simplicity and matcher uniformity.
