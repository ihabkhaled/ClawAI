...
import type { CheckoutMutationInput } from '@/types/billing-hook.types';
import type {
  BillingPlan,
  BillingUsage,
  CheckoutSessionView,
...
class BillingRepository {
  async listGateways(): Promise<CheckoutGatewayView[]> {
    const response = await apiClient.get<CheckoutGatewayView[]>('/billing/gateways');
  ...
  // payable order.
  async createCheckoutSession(input: CheckoutMutationInput): Promise<CheckoutSessionView> {
