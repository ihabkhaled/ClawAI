...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata('about');
}

export default function AboutPage(): Promise<React.ReactElement> {
  return PublicLaunchPage({ slug: PublicLaunchPageSlug.ABOUT });
}
