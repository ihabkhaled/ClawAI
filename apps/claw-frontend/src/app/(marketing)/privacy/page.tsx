...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata('privacy');
}

export default function PrivacyPage(): Promise<React.ReactElement> {
  return PublicLaunchPage({ slug: PublicLaunchPageSlug.PRIVACY });
}
