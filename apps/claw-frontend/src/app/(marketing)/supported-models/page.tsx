...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata('supported-models');
}

export default function SupportedModelsPage(): Promise<React.ReactElement> {
  return PublicLaunchPage({ slug: PublicLaunchPageSlug.SUPPORTED_MODELS });
}
