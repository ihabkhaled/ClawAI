...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata('terms');
}

export default function TermsPage(): Promise<React.ReactElement> {
  return PublicLaunchPage({ slug: PublicLaunchPageSlug.TERMS });
}
