...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_KIMI);
}

export default async function CompareKimiPage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.KIMI });
}
