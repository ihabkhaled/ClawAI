...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_CHATGPT);
}

export default async function CompareChatGptPage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.CHATGPT });
}
