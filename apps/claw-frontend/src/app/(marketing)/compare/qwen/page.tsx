...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_QWEN);
}

export default async function CompareQwenPage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.QWEN });
}
