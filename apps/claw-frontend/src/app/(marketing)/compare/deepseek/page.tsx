...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_DEEPSEEK);
}

export default async function CompareDeepseekPage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.DEEPSEEK });
}
