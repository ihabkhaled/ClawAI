...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_COPILOT);
}

export default async function CompareCopilotPage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.COPILOT });
}
