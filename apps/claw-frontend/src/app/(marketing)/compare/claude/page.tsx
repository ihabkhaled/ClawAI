...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_CLAUDE);
}

export default async function CompareClaudePage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.CLAUDE });
}
