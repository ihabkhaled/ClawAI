...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata(LaunchPublicPageSlug.COMPARE_PERPLEXITY);
}

export default async function ComparePerplexityPage(): Promise<React.ReactElement> {
  return ComparisonPage({ rival: ComparisonRival.PERPLEXITY });
}
