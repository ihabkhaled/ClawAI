...
export async function generateMetadata(): Promise<Metadata> {
  return buildRequestPublicPageMetadata('acceptable-use');
}

export default function AcceptableUsePage(): Promise<React.ReactElement> {
  return PublicLaunchPage({ slug: PublicLaunchPageSlug.ACCEPTABLE_USE });
}
