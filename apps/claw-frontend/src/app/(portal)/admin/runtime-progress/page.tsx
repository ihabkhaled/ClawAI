...
// Admin runtime diagnostics page. Renders one RuntimeProbeCard per supported
// local runtime (Ollama + llama.cpp today) plus a "refresh all" button that
// invalidates both probe queries in one shot. Gated to ADMIN via the
// existing AccessDenied pattern shared by the other admin pages.
