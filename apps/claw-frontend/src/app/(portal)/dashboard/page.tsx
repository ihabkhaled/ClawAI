...
import { DASHBOARD_STAT_CARDS, DASHBOARD_QUICK_ACTIONS } from '@/constants/dashboard.constants';
      ...
      <div className="mt-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Health aggregator integration coming soon. All services will be monitored here.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Connect to the health aggregator service to view real-time status of all
              microservices.
            </p>
          </CardContent>
        </Card>
