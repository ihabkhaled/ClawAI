...
const fromPlan = (plan: PlanView): PlanFormState => ({
  ...
  weeklyTokenQuota: numToStr(plan.weeklyTokenQuota),
  monthlyTokenQuota: numToStr(plan.monthlyTokenQuota),
  monthlyProviderCostCeilingMicroUsd: numToStr(plan.monthlyProviderCostCeilingMicroUsd),
  paygCreditPercentBps: String(plan.paygCreditPercentBps),
...
const buildPayload = (state: PlanFormState): Record<string, unknown> => ({
  ...
  weeklyTokenQuota: state.weeklyTokenQuota,
  monthlyTokenQuota: state.monthlyTokenQuota,
  monthlyProviderCostCeilingMicroUsd: state.monthlyProviderCostCeilingMicroUsd,
  paygCreditPercentBps: state.paygCreditPercentBps,
