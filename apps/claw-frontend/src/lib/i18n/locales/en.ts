...
export const en: TranslationDictionary = {
  ...
  auth: {
    ...
    mustChangePasswordBody:
      'Your current password was set by an administrator. Change it below before you carry on.',
    verifyEmailPendingTitle: 'Checking your link',
    verifyEmailPendingBody: 'One moment.',
    verifyEmailVerifiedTitle: 'Email confirmed',
    verifyEmailVerifiedBody: 'Your address is verified. You can sign in now.',
    verifyEmailAlreadyActiveTitle: 'Already active',
    verifyEmailAlreadyActiveBody:
      'This link has already been used, or an administrator activated your account for you. Try signing in.',
    verifyEmailFailedTitle: 'That link did not work',
    verifyEmailFailedBody: 'It may have expired. Sign in and request a new one.',
    backToHome: 'Back to home',
    emailPlaceholder: 'you@example.com',
    registerTitle: 'Create your ClawAI account',
  ...
  chat: {
    ...
    export: {
      action: 'Export',
      emptyThread: 'There is nothing to export yet — this conversation has no messages.',
    },
    reasoning: {
    ...
    stream: {
      ...
      stage: {
        ...
        crawlStarted: 'Crawling the website...',
        crawlDiscovering: 'Found {count} pages',
        crawlReadingPage: 'Reading {host}',
        crawlCompleted: 'Finished crawling',
    ...
    recorder: {
      ...
      recordVideo: 'Record a video note',
      unsupportedBrowser: 'This browser cannot record audio or video',
      recordingGroupLabel: 'Recording controls',
      recordingElapsed: 'Recording {time}',
      stop: 'Stop and attach the recording',
      cancel: 'Discard the recording',
      errorUnsupported: 'This browser cannot record audio or video',
      errorPermissionDenied: 'Microphone or camera access was refused',
      errorRecorderFailed: 'The recording failed',
      errorEmptyRecording: 'Nothing was recorded',
      consentAudioTitle: 'Record a voice note?',
      consentVideoTitle: 'Record a video note?',
      consentAudioDevices: 'This records your microphone only. Your camera stays off.',
      consentVideoDevices: 'This records your camera and your microphone.',
      consentPermission: 'Your browser will ask for permission next.',
      consentUpload: 'The recording is uploaded and sent to the AI model as an attachment.',
      consentMaxLength: 'Recording stops on its own after {minutes} minutes.',
      consentConfirm: 'Start recording',
      consentCancel: 'Cancel',
      send: 'Send now',
      fullScreenLabel: 'Recording',
      waveformLabel: 'Live audio level',
    ...
    imageStage: {
      ...
      loadingModel: 'Loading the image model',
      warmingUp: 'Warming up the image model',
      generating: 'Drawing the image',
      runningWorkflow: 'Running the image workflow',
      postProcessing: 'Refining the image',
      saving: 'Saving the image',
      working: 'Working on the image',
    },
    ...
    fileAvailableFor: 'Available for {minutes} min',
    fileExpired: 'Deleted after 1 hour',
    ...
    expandAnswer: 'Expand',
    answerRendered: 'Rendered',
    answerRaw: 'Raw markdown',
    exportFormats: {
      md: 'Markdown (.md)',
      txt: 'Plain text (.txt)',
      html: 'Web page (.html)',
      ...
      zip: 'Zip of code and tables (.zip)',
    },
  ...
  connectors: {
    ...
    manageExposure: 'Model exposure',
    backToConnector: 'Back to connector',
    name: 'Name',
    ...
    groupDirectLabs: 'Direct model labs',
    freeTierBadge: 'Free tier',
    searchProviderPlaceholder: 'Search providers...',
    noProviderResults: 'No providers found.',
    linkRegister: 'Sign up',
    linkApiKeys: 'API keys',
    linkPricing: 'Pricing',
    linkDocs: 'Docs',
    accountId: 'Account ID',
    accountIdHelp: 'Your Cloudflare account ID: 32 hexadecimal characters.',
    accountIdPlaceholder: 'e.g., 0123456789abcdef0123456789abcdef',
    resolvedUrlLabel: 'Resolves to:',
  },
  memory: {
    title: 'Memory',
  ...
  files: {
    ...
    statusFailed: 'Failed',
    uploadProgress: {
      percentLabel: '{percent}% uploaded',
      etaLabel: '{eta} remaining',
      etaUnknown: 'Calculating time remaining…',
      speedLabel: '{speed} per second',
    ...
    archive: {
      ...
      contentsOf: 'Contents of {filename}',
      loading: 'Loading archive contents…',
      loadFailed: 'Could not load the archive contents.',
      empty: 'This archive has no files.',
      unlisted: '{count} more files are not listed here.',
      attachWhole: 'Attach whole archive',
      attachWholeHint: 'Sends the file list and the text of every readable file.',
      chooseFiles: 'Choose files inside…',
      chooseFilesTitle: 'Choose files from {filename}',
      chooseFilesDescription:
        'Attach the whole archive, or pick only the files you need. Picking a file replaces the whole archive, so nothing is sent twice.',
      membersSelected: '{count} picked inside',
      done: 'Done',
      status: {
        extracted: 'Extracted',
        ...
        tooLarge: 'Too large',
        unsupported: 'No readable text',
        blocked: 'Blocked',
        tooDeep: 'Nested too deep',
      },
      rejected: {
        title: 'Archive rejected',
        warningTitle: 'Some files were skipped',
        bomb: 'It expands to far more data than it holds, which is how zip bombs work, so it was not opened.',
        tooLarge: 'Its contents are larger than the total size allowed for one upload.',
        tooManyEntries: 'It contains more files than one upload may hold.',
        traversal: 'It contains paths that point outside the archive, so it was not opened.',
        tooDeep: 'It nests archives inside archives deeper than allowed.',
        encrypted: 'It is password-protected. Enter the password to open it.',
        partlyEncrypted:
          'Some files are password-protected and were skipped. Enter the password to unlock them.',
        unsupported: 'This file is not an archive format we can open.',
        generic: 'It could not be opened. Try re-creating the archive and uploading it again.',
      },
      password: {
        unlockButton: 'Enter password',
        title: 'Enter the archive password',
        description: 'This archive is password-protected. Enter its password to open it.',
        placeholder: 'Password',
        submit: 'Unlock',
        cancel: 'Cancel',
        submitting: 'Checking password…',
        wrongPassword: 'That password did not work. Try again.',
        attemptsExceededTitle: 'Too many attempts',
        attemptsExceeded: 'This archive could not be unlocked after too many wrong passwords.',
  ...
  context: {
    ...
    typeSnippet: 'Snippet',
    typeMemoryRef: 'Memory Reference',
  },
  routing: {
  ...
  observability: {
    totalTokensCount: '{count} total tokens',
    status: {
      title: 'Service status',
      description:
        'Whether each part of the platform is answering right now, and how reliably it has answered over time.',
      overallLabel: 'Overall',
      loading: 'Checking services…',
      failedToLoad: 'Service status could not be loaded. It will try again automatically.',
      historyUnavailable:
        'Uptime history is unavailable right now. The current state below is still live.',
      uptime: 'Uptime',
      noData: 'No data',
      partialCoverage: 'Measured for {percent} of this period',
      incidentsTitle: 'Incidents in the last 7 days',
      noIncidents: 'No incidents in the last 7 days.',
      startedAt: 'Started {time}',
      lasted: 'Lasted {duration}',
      ongoingFor: 'Ongoing for {duration}',
      resolution:
        'Checked every 15 seconds and counted in 5-minute intervals. An interval counts against a component if any check in it failed.',
      windows: {
        day: '24 hours',
        week: '7 days',
        month: '30 days',
    ...
    grafana: {
      open: 'Open Grafana',
      opening: 'Opening Grafana…',
      failed: 'Could not open Grafana. Please try again.',
      hint: 'Opens the operational dashboards in a new tab, signed in as you.',
    },
  },
  audits: {
    title: 'Audit Logs',
  ...
  admin: {
    ...
    editUserSelfSuperAdminNotice:
      'This is your own super admin account. You can change your name here; role, status, plan and password rotation stay locked.',
    createUserTitle: 'Create user',
    createUserDescription:
      'The account is active immediately and the person is asked to change this password when they first sign in.',
    createUserEmail: 'Email',
    createUserEmailInvalid: 'Enter a valid email address.',
    createUserUsername: 'Username',
    createUserUsernameInvalid: 'Use 3-32 letters, numbers, hyphens or underscores.',
    createUserFirstName: 'First name',
    createUserLastName: 'Last name',
    createUserRole: 'Role',
    createUserAdminRestricted: 'Only the super admin can create another admin.',
    createUserPassword: 'Password',
    createUserGeneratePassword: 'Generate',
    createUserPasswordNotice:
      'You will need to pass this password on yourself. It is replaced the first time they sign in.',
    createUserPasswordStrength: 'Password strength',
    createUserPasswordWeak: 'Too weak',
    createUserPasswordFair: 'Fair',
    createUserPasswordGood: 'Good',
    createUserPasswordStrong: 'Strong',
    createUserPasswordNeedsLength: 'At least 8 characters',
    createUserPasswordNeedsUppercase: 'One uppercase letter',
    createUserPasswordNeedsLowercase: 'One lowercase letter',
    createUserPasswordNeedsDigit: 'One number',
    createUserPasswordNeedsSymbol: 'One symbol',
    createUserPasswordTooLong: 'At most 128 characters',
    createUserCancel: 'Cancel',
    createUserSubmit: 'Create user',
    createUserSucceeded: 'User created',
    createUserFailed: 'Could not create the user',
    activatePendingUser: 'Activate',
    activatePendingUserSucceeded: 'Account activated',
    activatePendingUserFailed: 'Could not activate the account',
    ...
    userUsageAction: 'Usage & consumption',
    userUsageDialogTitle: 'Usage and consumption',
    userUsageDialogDescription: 'Token and credit consumption for this account.',
    userUsageDialogDescriptionFor: 'Token and credit consumption for {username}.',
    userUsageLoading: 'Loading usage…',
    userUsageErrorTitle: 'Could not load usage',
    userUsageErrorDescription:
      'The consumption figures for this account could not be read. Try again.',
    userUsageTokensHeading: 'Token consumption',
    userUsageNoTokensRecorded: 'No tokens recorded in any window yet.',
    userUsageWindowDay: 'Today (UTC)',
    userUsageWindowWeek: 'This week (ISO)',
    userUsageWindowMonth: 'This month',
    userUsageWindowRange: '{from} to {through}',
    userUsageInputTokens: 'Input',
    userUsageOutputTokens: 'Output',
    userUsageRequestCount: 'Requests',
    userUsagePeriodKey: 'Period',
    userUsageCreditsHeading: 'Credit consumption by month',
    userUsageNoCreditsTitle: 'No credit consumption recorded',
    userUsageNoCreditsDescription:
      'This account has not spent any pay-as-you-go credit. Grants and expiries are not counted here.',
    userUsageCreditsMonth: 'Month',
    userUsageCreditsConsumed: 'Consumed',
    userUsageCreditsEntries: 'Ledger entries',
    userStatisticsGeneratedAt: 'Measured at {timestamp}',
    userSubscriptionAction: 'Subscription & billing',
    userSubscriptionDialogTitle: 'Subscription and billing',
    userSubscriptionDialogDescription: 'Plan, trial and payment history for this account.',
    userSubscriptionDialogDescriptionFor: 'Plan, trial and payment history for {username}.',
    userSubscriptionLoading: 'Loading subscription…',
    userSubscriptionErrorTitle: 'Could not load subscription',
    userSubscriptionErrorDescription:
      'The plan or the billing history for this account could not be read. Try again.',
    userSubscriptionPlanLabel: 'Plan',
    userSubscriptionNoPlan: 'No plan',
    userSubscriptionPlanSlugPrefix: 'Slug:',
    userSubscriptionMonthsPaidLabel: 'Months paid',
    userSubscriptionMonthsPaidDescription: 'Summed over paid invoices.',
    userSubscriptionPeriodLengthLabel: 'Billing period',
    userSubscriptionNoPeriodLength: 'No subscription',
    userSubscriptionPeriodLengthValue: '{months} months',
    userSubscriptionNextRenewalLabel: 'Next payment',
    userSubscriptionWillNotRenew: 'Will not renew',
    userSubscriptionWillNotRenewDescription: 'No further charge is scheduled for this account.',
    userSubscriptionPlanHeading: 'Plan, grant and trial',
    ...
    userSubscriptionNoGrant: 'None',
    userSubscriptionGrantStatusLabel: 'Grant status',
    userSubscriptionGrantStartsAt: 'Granted on',
    userSubscriptionEntitlementValidUntil: 'Access valid until',
    userSubscriptionNeverExpires: 'Never expires',
    userSubscriptionGrantReasonLabel: 'Reason',
    userSubscriptionCurrentHeading: 'Current subscription',
    ...
    userSubscriptionCurrentPeriodLabel: 'Current period',
    userSubscriptionCurrentPeriodValue: '{from} to {through}',
    userSubscriptionCancelAtPeriodEnd: 'Cancels at period end',
    userSubscriptionScheduledChange: 'Scheduled change',
    userSubscriptionScheduledChangeValue: 'To {plan} on {at}',
    userSubscriptionTotalPaidLabel: 'Total paid',
    userSubscriptionNothingPaid: 'Nothing paid',
    userSubscriptionHistoryHeading: 'Subscription history',
    userSubscriptionNoHistoryTitle: 'No subscription history',
    userSubscriptionNoHistoryDescription: 'This account has never held a subscription.',
    userSubscriptionHistoryPlan: 'Plan',
    userSubscriptionHistoryStatus: 'Status',
    userSubscriptionHistoryInterval: 'Cycle',
    userSubscriptionHistoryAmount: 'Amount',
    userSubscriptionHistoryPeriod: 'Period',
    userSubscriptionInvoicesHeading: 'Recent invoices',
    userSubscriptionNoInvoicesTitle: 'No invoices',
    userSubscriptionNoInvoicesDescription: 'No invoice has been issued to this account yet.',
    userSubscriptionInvoiceNumber: 'Number',
    userSubscriptionInvoiceStatus: 'Status',
    userSubscriptionInvoiceTotal: 'Total',
    userSubscriptionInvoicePaid: 'Paid',
    userSubscriptionInvoiceIssuedAt: 'Issued',
  },
  settings: {
    title: 'Settings',
    ...
    currencyAutomaticActive: 'Automatic — {currency}, detected from {country}',
    currencyManualActive: 'Showing prices in {currency}',
    ttsVoice: 'Read-aloud voice',
    ttsVoiceDescription: 'The voice that reads assistant replies aloud.',
    ttsVoiceLabel: 'Voice',
    ttsVoiceDefault: 'Default voice',
    ttsVoiceGroupGemini: 'Gemini voices',
    ttsVoiceGroupOpenAi: 'OpenAI voices',
    ttsVoiceFallbackNote:
      'A voice belongs to one provider. When the other provider reads a reply, it uses its own default voice. A new voice reads a reply again instead of replaying it.',
    system: 'System',
    light: 'Light',
    dark: 'Dark',
    theme: 'Theme',
  ...
  compare: {
    ...
    judgeRanked: 'Rank {rank} · {score}/{max}',
  ...
  connectorDetail: {
    ...
    healthOk: 'OK',
    activating:
      'Activating this connector — importing your first set of objects from the provider. You can keep using ClawAI while this runs.',
  ...
  agent: {
    ...
    noSessionsDesc: 'Start the ClawAI desktop agent on your machine to connect.',
  ...
  skippedProviders: SKIPPED_PROVIDERS_TRANSLATIONS.en,
  adminBilling: {
    credit: {
  ...
  adminConnectors: {
    exposure: {
      ...
      searchPlaceholder: 'Search models',
      filterAll: 'All',
      filterExposed: 'Exposed only',
      filterUnexposed: 'Unexposed only',
      loading: 'Loading models...',
      colModel: 'Model',
      ...
      exposed: 'Exposed',
      unexposed: 'Unexposed',
      exposeSelected: 'Expose selected',
      unexposeSelected: 'Unexpose selected',
  ...
  adminPlans: {
    ...
    setMostPopularSucceeded: 'Most popular plan updated.',
    setMostPopularFailed: 'Could not update the most popular plan.',
    setDefaultFailed: 'Could not set the signup plan.',
    ...
    gate: {
      ...
      allowImageGeneration: 'Image generation & editing',
      allowHelperVision: 'Helper vision (image descriptions)',
      allowTextToSpeech: 'Text-to-speech',
    },
    modelAccess: {
      title: 'Model Access',
  ...
  chatShare: {
    ...
    public: {
      ...
      sharedImage: 'Image shared in this conversation',
    ...
    home: {
      ...
      modelRoster: {
        ...
        modelsDialogDescription:
          'Every model ClawAI can serve from {provider} right now, on any paid plan.',
        modelsDialogClose: 'Close',
  ...
  feedback: {
    ...
    dialog: {
      typeLabel: 'Type',
      title: 'Send feedback',
      description: 'Tell us what happened. Screenshots and images help us fix it faster.',
      titleLabel: 'Title',
      titlePlaceholder: 'Short summary of the issue',
      subjectLabel: 'Subject',
      subjectPlaceholder: 'Optional — the area this affects',
      cancel: 'Cancel',
    ...
    type: { placeholder: 'Choose a feedback type' },
    types: {
      ...
      integrationIssue: 'Integration issue',
      documentation: 'Documentation',
    ...
    admin: {
      ...
      searchPlaceholder: 'Ticket number, title or reporter',
      hasAttachments: 'Has attachments',
      updated: 'Updated',
      type: { all: 'All types', placeholder: 'Filter by type' },
      status: {
        all: 'All',
        open: 'Open',
      ...
      detail: {
        ...
        imageUnavailable: 'This image could not be displayed',
    ...
    pasteOrUploadInstead: 'Capture unavailable — paste or upload an image instead',
    uploadAttachments: 'Upload images',
