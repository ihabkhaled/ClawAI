  ...
  files: {
    ...
    archive: {
      ...
      rejected: {
        ...
        encrypted: 'It is password-protected. Password-protected archives are not supported yet.',
        partlyEncrypted:
          'Some files are password-protected and were skipped. The rest are available.',
