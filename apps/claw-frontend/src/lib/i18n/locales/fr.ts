...
export const fr: TranslationDictionary = {
  ...
  auth: {
    ...
    mustChangePasswordBody:
      'Votre mot de passe actuel a été défini par un administrateur. Changez-le ci-dessous avant de continuer.',
    verifyEmailPendingTitle: 'Vérification de votre lien',
    verifyEmailPendingBody: 'Un instant.',
    verifyEmailVerifiedTitle: 'E-mail confirmé',
    verifyEmailVerifiedBody: 'Votre adresse est vérifiée. Vous pouvez vous connecter.',
    verifyEmailAlreadyActiveTitle: 'Déjà actif',
    verifyEmailAlreadyActiveBody:
      'Ce lien a déjà été utilisé, ou un administrateur a activé votre compte à votre place. Essayez de vous connecter.',
    verifyEmailFailedTitle: "Ce lien n'a pas fonctionné",
    verifyEmailFailedBody: 'Il a peut-être expiré. Connectez-vous et demandez-en un nouveau.',
    backToHome: 'Retour à l’accueil',
    emailPlaceholder: 'you@example.com',
    registerTitle: 'Créez votre compte ClawAI',
    ...
    forgotPasswordDescription: 'Saisissez votre e-mail pour recevoir un lien de réinitialisation.',
    ...
    forgotPasswordErrorGeneric: 'Une erreur est survenue. Veuillez réessayer.',
    forgotPasswordErrorTitle: 'Erreur',
    forgotPasswordSubmitting: 'Envoi en cours...',
    ...
    resetPasswordConfirmPasswordLabel: 'Confirmer le mot de passe',
    resetPasswordSubmit: 'Réinitialiser le mot de passe',
    resetPasswordSubmitting: 'Réinitialisation en cours...',
    ...
    resetPasswordErrorGeneric: 'Une erreur est survenue. Veuillez réessayer.',
    resetPasswordErrorTitle: 'Erreur',
  ...
  nav: {
    ...
    adminSmartRouter: 'Routeur intelligent',
    adminModelCosts: 'Prix des modèles',
    plan: 'Mon forfait',
    billing: 'Facturation',
    usage: 'Utilisation',
    more: 'Plus',
  ...
  chat: {
    ...
    speech: {
      ...
      pause: 'Pause',
      paused: 'En pause.',
      progress: 'Lecture de la partie {current} sur {total}…',
      waitingNext: 'Préparation de la partie suivante…',
      finished: 'Lecture à voix haute terminée.',
      cancelled: 'Lecture arrêtée.',
      partial:
        'Certaines parties de cette réponse n’ont pas pu être lues à voix haute et n’ont pas été facturées.',
      ...
      errors: {
        ...
        timedOut: 'La lecture à voix haute a pris trop de temps. Réessayez.',
        cancelPending:
          'La lecture à voix haute est encore en cours d’arrêt. Réessayez dans un instant.',
      },
    },
    edit: {
    ...
    search: {
      ...
      keepTyping: 'Continuez à saisir pour rechercher.',
      searching: 'Recherche…',
      noMatches: 'Aucun message ne correspond.',
      roleUser: 'Vous',
      notLoadedTitle: "Ce message n'est pas chargé",
      notLoaded:
        'Il se trouve plus haut dans la conversation. Faites défiler vers le haut pour le charger, puis relancez la recherche.',
    ...
    stream: {
      ...
      stage: {
        ...
        crawlStarted: 'Exploration du site...',
        crawlDiscovering: '{count} pages trouvées',
        crawlReadingPage: 'Lecture de {host}',
        crawlCompleted: 'Exploration terminée',
    ...
    recorder: {
      ...
      recordVideo: 'Enregistrer une note vidéo',
      unsupportedBrowser: 'Ce navigateur ne peut pas enregistrer d’audio ni de vidéo',
      recordingGroupLabel: 'Commandes d’enregistrement',
      recordingElapsed: 'Enregistrement {time}',
      stop: 'Arrêter et joindre l’enregistrement',
      cancel: 'Supprimer l’enregistrement',
      errorUnsupported: 'Ce navigateur ne peut pas enregistrer d’audio ni de vidéo',
      errorPermissionDenied: 'L’accès au micro ou à la caméra a été refusé',
      errorRecorderFailed: 'L’enregistrement a échoué',
      errorEmptyRecording: 'Rien n’a été enregistré',
      consentAudioTitle: 'Enregistrer une note vocale ?',
      consentVideoTitle: 'Enregistrer une note vidéo ?',
      consentAudioDevices: 'Seul votre micro est enregistré. Votre caméra reste éteinte.',
      consentVideoDevices: 'Votre caméra et votre micro sont enregistrés.',
      consentPermission: 'Votre navigateur va ensuite demander l’autorisation.',
      consentUpload: 'L’enregistrement est téléversé et envoyé au modèle d’IA en pièce jointe.',
      consentMaxLength: 'L’enregistrement s’arrête tout seul après {minutes} minutes.',
      consentConfirm: 'Démarrer l’enregistrement',
      consentCancel: 'Annuler',
      send: 'Envoyer maintenant',
      fullScreenLabel: 'Enregistrement',
      waveformLabel: 'Niveau audio en direct',
      cameraPreviewLabel: 'Aperçu de la caméra en direct',
    },
    ...
    imageCancel: 'Annuler',
    imageCancelling: 'Annulation…',
    imageCancelAria: 'Annuler la génération de l’image',
    ...
    imageStage: {
      ...
      loadingModel: "Chargement du modèle d'image",
      warmingUp: "Préchauffage du modèle d'image",
      generating: "Dessin de l'image",
      runningWorkflow: "Exécution du flux de travail de l'image",
      postProcessing: "Affinage de l'image",
      saving: "Enregistrement de l'image",
      working: "Traitement de l'image",
    },
    ...
    fileAvailableFor: 'Disponible pendant {minutes} min',
    fileExpired: 'Supprimé après 1 heure',
    ...
    answerRendered: 'Rendu',
    answerRaw: 'Markdown brut',
    exportFormats: {
      md: 'Markdown (.md)',
      txt: 'Texte brut (.txt)',
      html: 'Page web (.html)',
      ...
      zip: 'ZIP du code et des tableaux (.zip)',
    },
    ...
    truncated: {
      ...
      body: 'La réponse a atteint sa limite de longueur et a été coupée. Régénérez-la pour obtenir la réponse complète.',
    },
    routedBy: 'Routé par {router} ({routerProvider}) → répondu par {model}',
    toolTranscript: {
    ...
    upgrade: {
      ...
      features: {
        ...
        helperVision: 'Vision d’assistance',
  ...
  connectors: {
    ...
    groupAggregators: 'Agrégateurs',
    groupDirectLabs: 'Laboratoires de modèles directs',
    freeTierBadge: 'Niveau gratuit',
    searchProviderPlaceholder: 'Rechercher des fournisseurs...',
    noProviderResults: 'Aucun fournisseur trouvé.',
    linkRegister: "S'inscrire",
    linkApiKeys: 'Clés API',
    linkPricing: 'Tarification',
    linkDocs: 'Documentation',
    accountId: 'ID de compte',
    accountIdHelp: 'Votre identifiant de compte Cloudflare : 32 caractères hexadécimaux.',
    accountIdPlaceholder: 'ex. 0123456789abcdef0123456789abcdef',
    resolvedUrlLabel: 'Se résout en :',
  },
  memory: {
    title: 'Mémoire',
  ...
  files: {
    ...
    statusFailed: 'Échec',
    uploadProgress: {
      percentLabel: '{percent} % téléversé',
      etaLabel: '{eta} restant',
      etaUnknown: 'Calcul du temps restant…',
      speedLabel: '{speed} par seconde',
      elapsedLabel: 'Écoulé : {elapsed}',
    },
    archive: {
      badge: 'Archive',
  ...
  context: {
    ...
    typeSnippet: 'Extrait',
    typeMemoryRef: 'Référence mémoire',
  },
  routing: {
    ...
    models: {
      ...
      filterByRouterOnly: 'Routeur uniquement',
      routerOnlyAll: 'Tous les modèles',
      routerOnlyExecution: 'Exécution uniquement',
      routerOnlyRouter: 'Routeur uniquement',
    },
  },
  models: {
    serviceUnavailable: {
  ...
  observability: {
    ...
    status: {
      ...
      components: {
        ...
        webScraperCrawl4ai: 'Extracteur web : Crawl4AI',
        webScraperFlaresolverr: 'Extracteur web : FlareSolverr',
        webScraperFirecrawl: 'Extracteur web : Firecrawl',
  ...
  admin: {
    ...
    errors: {
      superAdminImmutable:
        'Seul le super administrateur peut modifier le compte super administrateur.',
    ...
    editUserSelfSuperAdminNotice:
      'Ceci est votre propre compte super administrateur. Vous pouvez modifier votre nom ici ; le rôle, le statut, le forfait et la rotation du mot de passe restent verrouillés.',
    createUserTitle: 'Créer un utilisateur',
    createUserDescription:
      'Le compte est actif immédiatement et la personne devra changer ce mot de passe à sa première connexion.',
    createUserEmail: 'E-mail',
    createUserEmailInvalid: 'Saisissez une adresse e-mail valide.',
    createUserUsername: "Nom d'utilisateur",
    createUserUsernameInvalid: 'Utilisez 3 à 32 lettres, chiffres, tirets ou tirets bas.',
    createUserFirstName: 'Prénom',
    createUserLastName: 'Nom',
    createUserRole: 'Rôle',
    createUserAdminRestricted: 'Seul le super administrateur peut créer un autre administrateur.',
    createUserPassword: 'Mot de passe',
    createUserGeneratePassword: 'Générer',
    createUserPasswordNotice:
      'Vous devrez transmettre ce mot de passe vous-même. Il est remplacé à la première connexion.',
    createUserPasswordStrength: 'Robustesse du mot de passe',
    createUserPasswordWeak: 'Trop faible',
    createUserPasswordFair: 'Correct',
    createUserPasswordGood: 'Bon',
    createUserPasswordStrong: 'Fort',
    createUserPasswordNeedsLength: 'Au moins 8 caractères',
    createUserPasswordNeedsUppercase: 'Une majuscule',
    createUserPasswordNeedsLowercase: 'Une minuscule',
    createUserPasswordNeedsDigit: 'Un chiffre',
    createUserPasswordNeedsSymbol: 'Un symbole',
    createUserPasswordTooLong: '128 caractères au maximum',
    createUserCancel: 'Annuler',
    createUserSubmit: "Créer l'utilisateur",
    createUserSucceeded: 'Utilisateur créé',
    createUserFailed: "Impossible de créer l'utilisateur",
    activatePendingUser: 'Activer',
    activatePendingUserSucceeded: 'Compte activé',
    activatePendingUserFailed: "Impossible d'activer le compte",
    ...
    assignPlanDialogTitle: 'Attribuer ce forfait',
    assignPlanDialogDescription: "Choisissez la durée de l'attribution et indiquez-en la raison.",
    assignPlanDurationLabel: 'Durée (mois)',
    assignPlanDurationInvalid: 'Saisissez un nombre entier de mois entre 1 et 60.',
    assignPlanReasonLabel: 'Motif',
    ...
    userUsageAction: 'Utilisation et consommation',
    userUsageDialogTitle: 'Utilisation et consommation',
    userUsageDialogDescription: 'Consommation de jetons et de crédit de ce compte.',
    userUsageDialogDescriptionFor: 'Consommation de jetons et de crédit de {username}.',
    userUsageLoading: 'Chargement de l’utilisation…',
    userUsageErrorTitle: 'Impossible de charger l’utilisation',
    userUsageErrorDescription:
      'Les chiffres de consommation de ce compte n’ont pas pu être lus. Réessayez.',
    userUsageTokensHeading: 'Consommation de jetons',
    userUsageNoTokensRecorded: 'Aucun jeton enregistré sur aucune période pour l’instant.',
    userUsageWindowDay: 'Aujourd’hui (UTC)',
    userUsageWindowWeek: 'Cette semaine (ISO)',
    userUsageWindowMonth: 'Ce mois-ci',
    userUsageWindowRange: 'Du {from} au {through}',
    userUsageInputTokens: 'Entrée',
    userUsageOutputTokens: 'Sortie',
    userUsageRequestCount: 'Requêtes',
    userUsagePeriodKey: 'Période',
    userUsageCreditsHeading: 'Consommation de crédit par mois',
    userUsageNoCreditsTitle: 'Aucune consommation de crédit enregistrée',
    userUsageNoCreditsDescription:
      'Ce compte n’a dépensé aucun crédit à l’usage. Les attributions et les expirations ne sont pas comptées ici.',
    userUsageCreditsMonth: 'Mois',
    userUsageCreditsConsumed: 'Consommé',
    userUsageCreditsEntries: 'Écritures du grand livre',
    userStatisticsGeneratedAt: 'Mesuré le {timestamp}',
    userSubscriptionAction: 'Abonnement et facturation',
    userSubscriptionDialogTitle: 'Abonnement et facturation',
    userSubscriptionDialogDescription:
      'Forfait, essai gratuit et historique de paiement de ce compte.',
    userSubscriptionDialogDescriptionFor:
      'Forfait, essai gratuit et historique de paiement de {username}.',
    userSubscriptionLoading: 'Chargement de l’abonnement…',
    userSubscriptionErrorTitle: 'Impossible de charger l’abonnement',
    userSubscriptionErrorDescription:
      'Le forfait ou l’historique de facturation de ce compte n’a pas pu être lu. Réessayez.',
    userSubscriptionPlanLabel: 'Forfait',
    userSubscriptionNoPlan: 'Aucun forfait',
    userSubscriptionPlanSlugPrefix: 'Identifiant :',
    userSubscriptionMonthsPaidLabel: 'Mois payés',
    userSubscriptionMonthsPaidDescription: 'Somme des factures acquittées.',
    userSubscriptionPeriodLengthLabel: 'Période de facturation',
    userSubscriptionNoPeriodLength: 'Aucun abonnement',
    userSubscriptionPeriodLengthValue: '{months} mois',
    userSubscriptionNextRenewalLabel: 'Prochain paiement',
    userSubscriptionWillNotRenew: 'Ne sera pas renouvelé',
    userSubscriptionWillNotRenewDescription: 'Aucun prélèvement n’est prévu pour ce compte.',
    userSubscriptionPlanHeading: 'Forfait, attribution et essai',
    ...
    userSubscriptionNoGrant: 'Aucune',
    userSubscriptionGrantStatusLabel: 'État de l’attribution',
    userSubscriptionGrantStartsAt: 'Attribué le',
    userSubscriptionEntitlementValidUntil: 'Accès valable jusqu’au',
    userSubscriptionNeverExpires: 'N’expire jamais',
    userSubscriptionGrantReasonLabel: 'Motif',
    userSubscriptionCurrentHeading: 'Abonnement en cours',
    ...
    userSubscriptionCurrentPeriodLabel: 'Période en cours',
    userSubscriptionCurrentPeriodValue: 'Du {from} au {through}',
    userSubscriptionCancelAtPeriodEnd: 'Résilié en fin de période',
    userSubscriptionScheduledChange: 'Changement programmé',
    userSubscriptionScheduledChangeValue: 'Vers {plan} le {at}',
    userSubscriptionTotalPaidLabel: 'Total payé',
    userSubscriptionNothingPaid: 'Rien de payé',
    userSubscriptionHistoryHeading: 'Historique des abonnements',
    userSubscriptionNoHistoryTitle: 'Aucun historique d’abonnement',
    userSubscriptionNoHistoryDescription: 'Ce compte n’a jamais eu d’abonnement.',
    userSubscriptionHistoryPlan: 'Forfait',
    userSubscriptionHistoryStatus: 'État',
    userSubscriptionHistoryInterval: 'Cycle',
    userSubscriptionHistoryAmount: 'Montant',
    userSubscriptionHistoryPeriod: 'Période',
    userSubscriptionInvoicesHeading: 'Factures récentes',
    userSubscriptionNoInvoicesTitle: 'Aucune facture',
    userSubscriptionNoInvoicesDescription: 'Aucune facture n’a encore été émise pour ce compte.',
    userSubscriptionInvoiceNumber: 'Numéro',
    userSubscriptionInvoiceStatus: 'État',
    userSubscriptionInvoiceTotal: 'Total',
    userSubscriptionInvoicePaid: 'Payé',
    userSubscriptionInvoiceIssuedAt: 'Émise le',
  },
  settings: {
    title: 'Paramètres',
    ...
    currency: 'Devise',
    currencyDescription: 'Choisissez la devise dans laquelle les prix sont affichés',
    currencyAutomaticActive: 'Automatique — {currency}, détectée depuis {country}',
    currencyManualActive: 'Prix affichés en {currency}',
    ttsVoice: 'Voix de lecture à voix haute',
    ttsVoiceDescription: "La voix qui lit à voix haute les réponses de l'assistant.",
    ttsVoiceLabel: 'Voix',
    ttsVoiceDefault: 'Voix par défaut',
    ttsVoiceGroupGemini: 'Voix Gemini',
    ttsVoiceGroupOpenAi: 'Voix OpenAI',
    ttsVoiceFallbackNote:
      "Une voix appartient à un seul fournisseur. Quand l'autre fournisseur lit une réponse, il utilise sa propre voix par défaut. Une nouvelle voix relit la réponse au lieu de la rejouer.",
    system: 'Système',
    light: 'Clair',
    dark: 'Sombre',
    theme: 'Thème',
  ...
  compare: {
    ...
    ranking: {
      title: 'Classement du juge',
      judgedBy: 'Évalué par {model}',
      method: 'Évalué sur une échelle commune de 0 à {max}.',
      tie: 'Égalité pour la première place.',
      rank: '#{rank}',
      candidateLabel: 'Candidat {label}',
      winner: 'Gagnant',
      score: '{score}/{max}',
  ...
  connectorDetail: {
    ...
    healthOk: 'OK',
    activating:
      "Activation de ce connecteur — import du premier ensemble d'objets depuis le fournisseur. Vous pouvez continuer à utiliser ClawAI pendant ce temps.",
  ...
  agent: {
    ...
    noSessionsDesc: "Démarrez l'agent de bureau ClawAI sur votre machine pour vous connecter.",
  ...
  adminWebhooks: {
    ...
    filter: {
      providerPlaceholder: 'Filtrer par fournisseur',
  ...
  routingPlayground: {
    ...
    form: {
      ...
      messagePlaceholder: 'Collez une invite…',
  ...
  adminPlans: {
    ...
    setMostPopularSucceeded: 'Forfait le plus populaire mis à jour.',
    setMostPopularFailed: 'Impossible de mettre à jour le forfait le plus populaire.',
    setDefaultFailed: "Impossible de définir le forfait d'inscription.",
    ...
    gate: {
      ...
      allowImageGeneration: 'Génération et retouche d’images',
      allowHelperVision: 'Vision d’assistance (descriptions d’images)',
      allowTextToSpeech: 'Synthèse vocale',
    },
    modelAccess: {
  ...
  chatShare: {
    ...
    public: {
      ...
      sharedImage: 'Image partagée dans cette conversation',
  ...
  billing: {
    credit: {
      ...
      kind: {
        ...
        GRANT_EXPIRY: 'Allocation non utilisée expirée',
        TOPUP: 'Crédit acheté',
        TOPUP_REVERSAL: 'Achat annulé',
        RESERVATION: 'Réservé',
        RESERVATION_RELEASE: 'Réservation libérée',
        CONSUMPTION: 'Utilisé',
        ADMIN_ADJUSTMENT: 'Ajustement manuel',
        PROVIDER_FAILURE_REFUND: 'Remboursé après une panne du fournisseur',
      },
  ...
  marketing: {
    ...
    home: {
      codingAgent: {
        eyebrow: 'Dans votre éditeur',
        title: 'ClawAI fonctionne dans VS Code',
        body: "Tous les modèles de votre abonnement, dans l'éditeur que vous utilisez déjà. L'extension est un client léger — votre compte, vos quotas et votre historique restent sur la plateforme, donc une conversation commencée dans le navigateur se poursuit dans l'éditeur.",
        point1Title: 'Pas de second abonnement',
        point1Body:
          'Elle utilise le compte ClawAI que vous avez déjà et le même quota. Rien de plus à acheter.',
        point2Title: "Aucune clé d'API dans votre éditeur",
        point2Body:
          "Le routage se fait sur la plateforme : l'extension ne détient jamais les identifiants d'un fournisseur de modèles.",
        point3Title: "Compatible avec l'auto-hébergement",
        point3Body:
          'Pointez-la vers la plateforme hébergée de ClawAI ou vers votre propre installation. Vous choisissez à la connexion.',
        ctaInstall: 'Installer depuis le Marketplace',
        ctaLearnMore: "Ce qu'elle fait",
      ...
      modelRoster: {
        ...
        modelsDialogDescription:
          'Tous les modèles que ClawAI peut servir depuis {provider} en ce moment, avec n’importe quelle offre payante.',
        modelsDialogClose: 'Fermer',
  ...
  pwa: {
    ...
    installTitle: 'Installer ClawAI',
    installMessage: 'S’ouvre dans sa propre fenêtre et continue de fonctionner hors ligne.',
    installAction: 'Installer',
    dismissInstall: 'Fermer la notification d’installation',
    minimise: 'Réduire',
    expand: 'Installer ClawAI',
    neverShowAgain: 'Ne plus afficher',
  },
  profile: {
    title: 'Profil',
    description: 'Vos informations personnelles et votre façon de vous connecter.',
    identityTitle: 'Informations personnelles',
    identityDescription:
      'Vous pouvez modifier les noms et le téléphone à tout moment. Laissez un champ vide pour l’effacer.',
    firstName: 'Prénom',
    lastName: 'Nom',
    phone: 'Téléphone',
    phonePlaceholder: '+14155550123',
    phoneInvalid: 'Saisissez un numéro au format international, par exemple +14155550123.',
    username: 'Nom d’utilisateur',
    ...
    currentPassword: 'Mot de passe actuel',
    currentPasswordRequired: 'Saisissez votre mot de passe actuel pour enregistrer.',
    nameTooLong: 'Utilisez 64 caractères au maximum.',
  ...
  feedback: {
    ...
    dialog: {
      ...
      description:
        'Dites-nous ce qui s’est passé. Les captures et images nous aident à corriger plus vite.',
      titleLabel: 'Titre',
      titlePlaceholder: 'Résumé court du problème',
      subjectLabel: 'Objet',
      subjectPlaceholder: 'Facultatif — la zone concernée',
      cancel: 'Annuler',
      submit: 'Envoyer',
      submitting: 'Envoi…',
    },
    ...
    type: { placeholder: 'Choisissez un type de retour' },
    types: {
      ...
      dataIssue: 'Problème de données',
      integrationIssue: 'Problème d’intégration',
      documentation: 'Documentation',
      securityConcern: 'Problème de sécurité',
      other: 'Autre',
    },
    errors: {
      typeRequired: 'Choisissez un type de retour',
    ...
    admin: {
      title: 'Retours',
      searchLabel: 'Rechercher un retour',
      searchPlaceholder: 'Numéro de ticket, titre ou auteur',
      hasAttachments: 'Avec pièces jointes',
      updated: 'Mis à jour',
      type: { all: 'Tous les types', placeholder: 'Filtrer par type' },
      status: {
        all: 'Tous',
        open: 'Ouvert',
        inProgress: 'En cours',
      ...
      detail: {
        ...
        imageUnavailable: 'Cette image n’a pas pu être affichée',
        ...
        imagePreview: 'Aperçu de la pièce jointe',
      },
      table: {
        ticket: 'Ticket',
        type: 'Type',
      ...
      actions: {
        markInProgress: 'Passer en cours',
        resolve: 'Résoudre',
        close: 'Fermer',
        reopen: 'Rouvrir',
        archive: 'Archiver',
    ...
    screenshot: {
      failed: 'La capture d’écran ne s’est pas terminée',
      unsupported: 'La capture d’écran n’est pas disponible dans ce navigateur',
    },
    captureScreenshot: 'Capturer l’écran',
    capturing: 'Capture…',
    screenshotPreview: 'Capture d’écran',
    removeScreenshot: 'Supprimer la capture',
    pasteOrUploadInstead: 'Capture indisponible — collez ou importez une image à la place',
    uploadAttachments: 'Importer des images',
