...
export const de: TranslationDictionary = {
  ...
  auth: {
    ...
    registerTitle: 'Erstelle dein ClawAI-Konto',
  ...
  chat: {
    ...
    modelSelector: {
      autoLabel: 'Automatisch (Routing entscheidet)',
      autoShortLabel: 'Auto',
    ...
    stream: {
      ...
      stage: {
        ...
        crawlStarted: 'Website wird durchsucht...',
        crawlDiscovering: '{count} Seiten gefunden',
        crawlReadingPage: '{host} wird gelesen',
        crawlCompleted: 'Durchsuchen abgeschlossen',
    ...
    attachment: {
      ...
      play: 'Abspielen',
      loading: 'Wird geladen…',
      previewFailed: 'Dieser Anhang konnte nicht geladen werden',
      download: 'Herunterladen',
      view: 'Öffnen',
    ...
    recorder: {
      ...
      recordVideo: 'Videonotiz aufnehmen',
      unsupportedBrowser: 'Dieser Browser kann kein Audio oder Video aufnehmen',
      recordingGroupLabel: 'Aufnahmesteuerung',
      recordingElapsed: 'Aufnahme {time}',
      stop: 'Aufnahme beenden und anhängen',
      cancel: 'Aufnahme verwerfen',
      errorUnsupported: 'Dieser Browser kann kein Audio oder Video aufnehmen',
      errorPermissionDenied: 'Zugriff auf Mikrofon oder Kamera wurde verweigert',
      errorRecorderFailed: 'Die Aufnahme ist fehlgeschlagen',
      errorEmptyRecording: 'Es wurde nichts aufgenommen',
      consentAudioTitle: 'Sprachnotiz aufnehmen?',
      consentVideoTitle: 'Videonotiz aufnehmen?',
      consentAudioDevices: 'Dabei wird nur Ihr Mikrofon aufgenommen. Die Kamera bleibt aus.',
      consentVideoDevices: 'Dabei werden Ihre Kamera und Ihr Mikrofon aufgenommen.',
      consentPermission: 'Ihr Browser fragt als Nächstes nach der Berechtigung.',
      consentUpload: 'Die Aufnahme wird hochgeladen und als Anhang an das KI-Modell gesendet.',
      consentMaxLength: 'Die Aufnahme stoppt nach {minutes} Minuten von selbst.',
      consentConfirm: 'Aufnahme starten',
      consentCancel: 'Abbrechen',
      send: 'Jetzt senden',
      fullScreenLabel: 'Aufnahme',
      waveformLabel: 'Live-Audiopegel',
      cameraPreviewLabel: 'Live-Kameravorschau',
    },
    ...
    imageStage: {
      ...
      loadingModel: 'Bildmodell wird geladen',
      warmingUp: 'Bildmodell wird aufgewärmt',
      generating: 'Bild wird gezeichnet',
      runningWorkflow: 'Bild-Workflow läuft',
      postProcessing: 'Bild wird verfeinert',
      saving: 'Bild wird gespeichert',
      working: 'Bild wird bearbeitet',
    },
    ...
    fileAvailableFor: 'Noch {minutes} Min. verfügbar',
    fileExpired: 'Nach 1 Stunde gelöscht',
    ...
    answerRendered: 'Gerendert',
    answerRaw: 'Roh-Markdown',
    exportFormats: {
      md: 'Markdown (.md)',
      txt: 'Reiner Text (.txt)',
      html: 'Webseite (.html)',
      ...
      zip: 'ZIP mit Code und Tabellen (.zip)',
    },
    ...
    upgrade: {
      ...
      features: {
        ...
        imageGeneration: 'Bildgenerierung',
        helperVision: 'Hilfs-Bilderkennung',
  ...
  connectors: {
    ...
    groupAggregators: 'Aggregatoren',
    groupDirectLabs: 'Direkte Modelllabore',
    freeTierBadge: 'Kostenlose Stufe',
    searchProviderPlaceholder: 'Anbieter suchen...',
    noProviderResults: 'Keine Anbieter gefunden.',
    linkRegister: 'Registrieren',
    linkApiKeys: 'API-Schlüssel',
    linkPricing: 'Preise',
    linkDocs: 'Dokumentation',
    accountId: 'Konto-ID',
    accountIdHelp: 'Ihre Cloudflare-Konto-ID: 32 hexadezimale Zeichen.',
    accountIdPlaceholder: 'z. B. 0123456789abcdef0123456789abcdef',
    resolvedUrlLabel: 'Ergibt:',
  },
  memory: {
    title: 'Speicher',
  ...
  files: {
    ...
    uploadProgress: {
      percentLabel: '{percent}% hochgeladen',
      etaLabel: '{eta} verbleibend',
      etaUnknown: 'Verbleibende Zeit wird berechnet …',
      speedLabel: '{speed} pro Sekunde',
      elapsedLabel: 'Verstrichen: {elapsed}',
    },
    archive: {
      badge: 'Archiv',
  ...
  context: {
    ...
    typeSnippet: 'Ausschnitt',
    typeMemoryRef: 'Speicherverweis',
  },
  routing: {
  ...
  observability: {
    ...
    status: {
      ...
      components: {
        ...
        chat: 'Chat',
        files: 'Dateien',
        antivirus: 'Virenscanner (ClamAV)',
        webScraperCrawl4ai: 'Web-Scraper: Crawl4AI',
        webScraperFlaresolverr: 'Web-Scraper: FlareSolverr',
        webScraperFirecrawl: 'Web-Scraper: Firecrawl',
  ...
  admin: {
    ...
    userUsageAction: 'Nutzung & Verbrauch',
    userUsageDialogTitle: 'Nutzung und Verbrauch',
    userUsageDialogDescription: 'Token- und Guthabenverbrauch dieses Kontos.',
    userUsageDialogDescriptionFor: 'Token- und Guthabenverbrauch von {username}.',
    userUsageLoading: 'Nutzung wird geladen …',
    userUsageErrorTitle: 'Nutzung konnte nicht geladen werden',
    userUsageErrorDescription:
      'Die Verbrauchszahlen dieses Kontos konnten nicht gelesen werden. Bitte erneut versuchen.',
    userUsageTokensHeading: 'Tokenverbrauch',
    userUsageNoTokensRecorded: 'Bisher wurden in keinem Zeitraum Token erfasst.',
    userUsageWindowDay: 'Heute (UTC)',
    userUsageWindowWeek: 'Diese Woche (ISO)',
    userUsageWindowMonth: 'Dieser Monat',
    userUsageWindowRange: '{from} bis {through}',
    userUsageInputTokens: 'Eingabe',
    userUsageOutputTokens: 'Ausgabe',
    userUsageRequestCount: 'Anfragen',
    userUsagePeriodKey: 'Zeitraum',
    userUsageCreditsHeading: 'Guthabenverbrauch nach Monat',
    userUsageNoCreditsTitle: 'Kein Guthabenverbrauch erfasst',
    userUsageNoCreditsDescription:
      'Dieses Konto hat kein nutzungsbasiertes Guthaben ausgegeben. Gutschriften und Verfall werden hier nicht gezählt.',
    userUsageCreditsMonth: 'Monat',
    userUsageCreditsConsumed: 'Verbraucht',
    userUsageCreditsEntries: 'Buchungen',
    userStatisticsGeneratedAt: 'Gemessen am {timestamp}',
    userSubscriptionAction: 'Abo & Abrechnung',
    userSubscriptionDialogTitle: 'Abonnement und Abrechnung',
    userSubscriptionDialogDescription: 'Tarif, Testphase und Zahlungsverlauf dieses Kontos.',
    userSubscriptionDialogDescriptionFor: 'Tarif, Testphase und Zahlungsverlauf von {username}.',
    userSubscriptionLoading: 'Abonnement wird geladen …',
    userSubscriptionErrorTitle: 'Abonnement konnte nicht geladen werden',
    userSubscriptionErrorDescription:
      'Tarif oder Abrechnungsverlauf dieses Kontos konnten nicht gelesen werden. Bitte erneut versuchen.',
    userSubscriptionPlanLabel: 'Tarif',
    userSubscriptionNoPlan: 'Kein Tarif',
    userSubscriptionPlanSlugPrefix: 'Kürzel:',
    userSubscriptionMonthsPaidLabel: 'Bezahlte Monate',
    userSubscriptionMonthsPaidDescription: 'Summe über bezahlte Rechnungen.',
    userSubscriptionPeriodLengthLabel: 'Abrechnungszeitraum',
    userSubscriptionNoPeriodLength: 'Kein Abonnement',
    userSubscriptionPeriodLengthValue: '{months} Monate',
    userSubscriptionNextRenewalLabel: 'Nächste Zahlung',
    userSubscriptionWillNotRenew: 'Wird nicht verlängert',
    userSubscriptionWillNotRenewDescription:
      'Für dieses Konto ist keine weitere Abbuchung vorgesehen.',
    userSubscriptionPlanHeading: 'Tarif, Zuweisung und Testphase',
    ...
    userSubscriptionNoGrant: 'Keine',
    userSubscriptionGrantStatusLabel: 'Status der Zuweisung',
    userSubscriptionGrantStartsAt: 'Zugewiesen am',
    userSubscriptionEntitlementValidUntil: 'Zugang gültig bis',
    userSubscriptionNeverExpires: 'Läuft nie ab',
    userSubscriptionGrantReasonLabel: 'Begründung',
    userSubscriptionCurrentHeading: 'Aktuelles Abonnement',
    ...
    userSubscriptionCurrentPeriodLabel: 'Laufender Zeitraum',
    userSubscriptionCurrentPeriodValue: '{from} bis {through}',
    userSubscriptionCancelAtPeriodEnd: 'Endet zum Periodenende',
    userSubscriptionScheduledChange: 'Geplante Änderung',
    userSubscriptionScheduledChangeValue: 'Zu {plan} am {at}',
    userSubscriptionTotalPaidLabel: 'Insgesamt gezahlt',
    userSubscriptionNothingPaid: 'Nichts gezahlt',
    userSubscriptionHistoryHeading: 'Abonnementverlauf',
    userSubscriptionNoHistoryTitle: 'Kein Abonnementverlauf',
    userSubscriptionNoHistoryDescription: 'Dieses Konto hatte nie ein Abonnement.',
    userSubscriptionHistoryPlan: 'Tarif',
    userSubscriptionHistoryStatus: 'Status',
    userSubscriptionHistoryInterval: 'Rhythmus',
    userSubscriptionHistoryAmount: 'Betrag',
    userSubscriptionHistoryPeriod: 'Zeitraum',
    userSubscriptionInvoicesHeading: 'Letzte Rechnungen',
    userSubscriptionNoInvoicesTitle: 'Keine Rechnungen',
    userSubscriptionNoInvoicesDescription:
      'Für dieses Konto wurde noch keine Rechnung ausgestellt.',
    userSubscriptionInvoiceNumber: 'Nummer',
    userSubscriptionInvoiceStatus: 'Status',
    userSubscriptionInvoiceTotal: 'Gesamt',
    userSubscriptionInvoicePaid: 'Bezahlt',
    userSubscriptionInvoiceIssuedAt: 'Ausgestellt',
  },
  settings: {
    title: 'Einstellungen',
    ...
    currency: 'Währung',
    currencyDescription: 'Wählen Sie die Währung, in der Preise angezeigt werden',
    currencyAutomaticActive: 'Automatisch — {currency}, erkannt aus {country}',
    currencyManualActive: 'Preise werden in {currency} angezeigt',
    ttsVoice: 'Vorlesestimme',
    ttsVoiceDescription: 'Die Stimme, die Antworten des Assistenten vorliest.',
    ttsVoiceLabel: 'Stimme',
    ttsVoiceDefault: 'Standardstimme',
    ttsVoiceGroupGemini: 'Gemini-Stimmen',
    ttsVoiceGroupOpenAi: 'OpenAI-Stimmen',
    ttsVoiceFallbackNote:
      'Eine Stimme gehört zu einem Anbieter. Liest der andere Anbieter eine Antwort vor, nutzt er seine eigene Standardstimme. Mit einer neuen Stimme wird eine Antwort neu vorgelesen statt wiederholt.',
    system: 'System',
    light: 'Hell',
    dark: 'Dunkel',
    theme: 'Design',
  ...
  compare: {
    ...
    judgeRanked: 'Rang {rank} · {score}/{max}',
    ...
    ranking: {
      title: 'Bewertung des Richters',
      judgedBy: 'Bewertet von {model}',
      method: 'Bewertet auf einer gemeinsamen Skala von 0–{max}.',
      tie: 'Gleichstand um den ersten Platz.',
      rank: '#{rank}',
      candidateLabel: 'Kandidat {label}',
      winner: 'Gewinner',
      score: '{score}/{max}',
  ...
  connectorDetail: {
    ...
    healthOk: 'OK',
    activating:
      'Konnektor wird aktiviert – Ihre ersten Objekte werden vom Provider importiert. Sie können ClawAI währenddessen weiter nutzen.',
  ...
  agent: {
    ...
    noSessionsDesc:
      'Starten Sie den ClawAI-Desktop-Agent auf Ihrer Maschine, um sich zu verbinden.',
  ...
  adminPlans: {
    ...
    setMostPopularSucceeded: 'Beliebtester Tarif aktualisiert.',
    setMostPopularFailed: 'Beliebtester Tarif konnte nicht aktualisiert werden.',
    setDefaultFailed: 'Registrierungstarif konnte nicht festgelegt werden.',
    ...
    gate: {
      ...
      allowImageGeneration: 'Bilder erstellen und bearbeiten',
      allowHelperVision: 'Hilfs-Bilderkennung (Bildbeschreibungen)',
      allowTextToSpeech: 'Sprachausgabe (Text-to-Speech)',
    },
    modelAccess: {
      title: 'Modellzugriff',
  ...
  marketing: {
    ...
    home: {
      ...
      modelRoster: {
        showAllModels: 'Alle {count} Modelle anzeigen',
        modelsDialogDescription:
          'Alle Modelle, die ClawAI derzeit von {provider} bereitstellen kann – in jedem kostenpflichtigen Tarif.',
        modelsDialogClose: 'Schließen',
