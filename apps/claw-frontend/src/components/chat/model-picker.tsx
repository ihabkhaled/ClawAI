...
// Shared searchable, single-select model combobox. Every model-picker call
// site (composer, thread settings, orchestration labs, judge/critic)
// normalizes its own data (grouped ModelSelection[] or flat
// JudgeModelOption[]) into ModelPickerGroup[] and renders this — see
// utilities/model-selector.utility.ts for the ModelSelection[] adapter.
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <span className="min-w-0 flex-1 truncate text-left">{resolveTriggerLabel()}</span>
        </Button>
      </PopoverTrigger>
