  ...
  return (
    <div className="border-border grid grid-cols-1 gap-2 border-t pt-4">
      ...
      <dl className="grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
        ...
        <div className="bg-muted/35 flex justify-between gap-3 rounded-md px-3 py-2">
          <dt className="text-muted-foreground">{t('adminPlans.form.maxMessagesPerDay')}</dt>
          <dd className="font-medium tabular-nums">
            {formatNullableLimit(limits.messagesPerDay, t('userUsage.unlimited'))}
          </dd>
        </div>
        <div className="bg-muted/35 flex justify-between gap-3 rounded-md px-3 py-2">
          <dt className="text-muted-foreground">{t('adminPlans.form.maxWorkspaceConnections')}</dt>
          <dd className="font-medium tabular-nums">
            {formatNullableLimit(limits.workspaceConnections, t('userUsage.unlimited'))}
          </dd>
        </div>
        <div className="bg-muted/35 flex justify-between gap-3 rounded-md px-3 py-2">
          <dt className="text-muted-foreground">{t('adminPlans.form.maxContextPacks')}</dt>
          <dd className="font-medium tabular-nums">
            {formatNullableLimit(limits.contextPacks, t('userUsage.unlimited'))}
          </dd>
        </div>
        <div className="bg-muted/35 flex justify-between gap-3 rounded-md px-3 py-2">
          <dt className="text-muted-foreground">{t('adminPlans.form.maxMemoryItems')}</dt>
          <dd className="font-medium tabular-nums">
            {formatNullableLimit(limits.memoryItems, t('userUsage.unlimited'))}
          </dd>
        </div>
      </dl>
    </div>
