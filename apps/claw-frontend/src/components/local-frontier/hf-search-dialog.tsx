  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle>Browse HuggingFace GGUF models</DialogTitle>
          <DialogDescription>
            Live search across HuggingFace. Pick a quantization, choose a category, and import the
            model into the local frontier catalog.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <Input
              ...
              placeholder="Search HuggingFace (leave blank for top trending)"
              className="pl-8"
            />
          </div>
