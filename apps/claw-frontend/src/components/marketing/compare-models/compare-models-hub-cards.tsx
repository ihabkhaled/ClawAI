...
import type { CompareModelsHubCardsProps } from '@/types/compare-models-component.types';

export function CompareModelsHubCards({ cards }: CompareModelsHubCardsProps): React.ReactElement {
  return (
    <ul className="editorial-comparison__cards">
      {cards.map((card) => (
        <li key={card.pair} className="editorial-comparison__card">
