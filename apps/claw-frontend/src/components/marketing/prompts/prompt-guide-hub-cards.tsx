...
import type { PromptGuideHubCardsProps } from '@/types/prompt-guide-component.types';

export function PromptGuideHubCards({ cards }: PromptGuideHubCardsProps): React.ReactElement {
  return (
