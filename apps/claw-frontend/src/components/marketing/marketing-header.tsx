...
export function MarketingHeader(): React.ReactElement {
  ...
  return (
    <header
      // Same contract as the portal topbar: the toast column measures around
      // whatever is pinned to the top edge.
      data-top-obstacle=""
      className="border-border bg-background/95 supports-[backdrop-filter]:bg-background/75 sticky top-0 z-40 w-full border-b backdrop-blur"
    >
