  ...
  hub: {
    ...
    cardSummaries: {
      ...
      [LearnTopic.AI_DATA_PRIVACY_AND_RETENTION]:
        'Qué pasa realmente con lo que escribes en un producto de IA — quién lo ve, si entrena un modelo, y cuánto tiempo se queda ahí.',
    },
  },
  topics: {
    [LearnTopic.HOW_LANGUAGE_MODELS_GENERATE_ANSWERS]: {
    ...
    [LearnTopic.WHAT_ARE_STRUCTURED_AI_OUTPUTS]: {
      seo: {
        title: '¿Qué son las salidas estructuradas de IA?',
        description:
        ...
        keywords: [
          ...
          'generación de IA restringida por esquema',
        ],
      },
      eyebrow: 'Fundamentos',
      title: '¿Qué son las salidas estructuradas de IA?',
      summary:
        'Una salida estructurada es una respuesta del modelo con una forma específica —normalmente JSON según un esquema definido— en vez de prosa libre, para que el código pueda analizarla sin adivinar. Lo que sorprende es que "pedirle al modelo que devuelva JSON" y "el modelo garantiza devolver JSON válido" son dos afirmaciones distintas, y solo algunos mecanismos cumplen de verdad la segunda.',
      sections: [
        {
          id: 'what-structured-output-means',
          heading: 'Estructura significa que el código que la consume puede confiar en la forma',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Hay dos formas distintas de pedirla',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Una instrucción en el prompt es una petición, no una garantía',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'La estructura impuesta por el proveedor es otro tipo de garantía',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Una forma válida no es lo mismo que una respuesta correcta',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Analizarla con éxito no es lo mismo que poder confiar en ella',
          paragraphs: [
      ...
      faq: [
        {
          question: '¿Una salida estructurada es lo mismo que una llamada a herramienta?',
          answer:
        ...
        {
          question: '¿Pedirle JSON al modelo en el prompt garantiza recibir JSON válido?',
          answer:
        ...
        {
          question: '¿Todavía necesito validar una respuesta estructurada antes de usarla?',
          answer:
    ...
    [LearnTopic.HOW_TO_READ_AI_BENCHMARKS]: {
      seo: {
        title: 'Cómo leer los benchmarks de IA sin dejarte engañar',
        description:
        ...
        keywords: [
          'cómo leer benchmarks de IA',
          'puntuaciones de benchmark de IA explicadas',
          'entender los benchmarks de LLM',
        ],
      },
      eyebrow: 'Fundamentos',
      title: 'Cómo leer los benchmarks de IA sin dejarte engañar',
      summary:
        'Una puntuación de benchmark mide el rendimiento en un único conjunto fijo y específico de preguntas de prueba, ni más ni menos. El número parece preciso y objetivo, y precisamente por eso es fácil confiar demasiado en él: una sola cifra no puede mostrarte qué cubrió la prueba, cómo se le preguntó al modelo, o si las preguntas se filtraron a los datos de entrenamiento antes de que el modelo las viera de verdad por primera vez.',
      sections: [
        {
          id: 'a-benchmark-is-one-fixed-test-not-a-general-measure',
          heading: 'Un benchmark es una prueba fija, no una medida general de capacidad',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Las preguntas de un benchmark pueden filtrarse a los datos de entrenamiento',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'La puntuación reportada puede depender mucho de cómo se le preguntó al modelo',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Una sola puntuación media oculta justo dónde falla realmente un modelo',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Trata un benchmark como punto de partida, no como veredicto',
          paragraphs: [
      ...
      faq: [
        {
          question: '¿Qué prueba realmente un benchmark como MMLU o HumanEval?',
          answer:
        ...
        {
          question: '¿Qué es la contaminación de benchmark?',
          answer:
        ...
        {
          question: '¿Debería ignorar por completo las puntuaciones de benchmark?',
          answer:
    ...
    [LearnTopic.AI_DATA_PRIVACY_AND_RETENTION]: {
      seo: {
        title: 'Privacidad y retención de datos de IA, explicadas',
        description:
        ...
        keywords: [
          'privacidad de datos de IA explicada',
      ...
      title: 'Privacidad y retención de datos de IA, explicadas',
      summary:
        'Lo que pasa con lo que escribes en un producto de IA depende de un puñado de preguntas concretas: si sale de tu propia infraestructura siquiera, si el proveedor lo usa para entrenar modelos futuros, cuánto tiempo se almacena, y quién más —subprocesadores, sistemas de registro, revisores humanos— podría verlo por el camino. Nada de esto es universal; varía según el producto y el proveedor, y por eso vale la pena saber qué preguntar.',
      sections: [
        {
          id: 'where-your-input-actually-goes',
          heading: 'La primera pregunta: si sale de tu infraestructura siquiera',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Un periodo de retención solo importa si el borrado realmente ocurre',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'El recorrido de tus datos suele incluir más partes que solo el proveedor de IA',
          paragraphs: [
      ...
      faq: [
        {
          question: '¿Todos los productos de IA usan mis conversaciones para entrenar sus modelos?',
          answer:
        ...
        {
          question: 'Si borro mis datos, ¿desaparecen de inmediato?',
          answer:
        ...
        {
          question: '¿La IA local es automáticamente más privada que un producto de IA en la nube?',
          answer:
        ...
        {
          question: '¿Qué son los subprocesadores, y por qué importan para la privacidad?',
          answer:
