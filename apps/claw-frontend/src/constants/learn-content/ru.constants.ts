  ...
  hub: {
    ...
    cardSummaries: {
      ...
      [LearnTopic.WHAT_IS_PROMPT_INJECTION]:
        'Текст, который написали не вы, всё равно может дать модели инструкции — что это значит и почему более умная модель не решает это полностью.',
      [LearnTopic.AI_DATA_PRIVACY_AND_RETENTION]:
        'Что на самом деле происходит с тем, что вы вводите в ИИ-продукт — кто это видит, обучает ли это модель и как долго это хранится.',
    },
  },
  topics: {
    [LearnTopic.HOW_LANGUAGE_MODELS_GENERATE_ANSWERS]: {
    ...
    [LearnTopic.WHAT_IS_PROMPT_INJECTION]: {
      seo: {
        title: 'Что такое инъекция промпта?',
        description:
        ...
        keywords: [
          ...
          'атака через инъекцию промпта объяснение',
      ...
      title: 'Что такое инъекция промпта?',
      summary:
        'Инъекция промпта — это текст, написанный не вами, который всё равно даёт модели инструкции — спрятанный на веб-странице, которую она читает, в документе, который она резюмирует, или в результате инструмента, который она вызывает. У языковой модели нет надёжного встроенного способа отделить «инструкции пользователя» от «текста, который случайно похож на инструкции», потому что оба приходят как один и тот же тип входных данных: слова в окне контекста.',
      sections: [
        {
          id: 'direct-vs-indirect-injection',
          heading: 'Две формы: прямая и непрямая',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Почему более умная модель не решает это сама по себе',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Риск резко возрастает, как только модель может вызывать инструменты',
          paragraphs: [
      ...
      faq: [
        {
          question: 'Можно ли полностью предотвратить инъекцию промпта?',
          answer:
        ...
        {
          question: 'Инъекция промпта — это то же самое, что джейлбрейк?',
          answer:
        ...
        {
          question: 'Достаточно ли сканирования контента на шаблоны инъекции для защиты?',
          answer:
    ...
    [LearnTopic.AI_DATA_PRIVACY_AND_RETENTION]: {
      seo: {
        title: 'Приватность и хранение данных ИИ: объяснение',
        description:
        ...
        keywords: [
          'приватность данных ИИ объяснение',
          'хранение данных ИИ',
      ...
      title: 'Приватность и хранение данных ИИ: объяснение',
      summary:
        'То, что происходит с введённым вами в ИИ-продукт, зависит от нескольких конкретных вопросов: уходит ли это вообще за пределы вашей собственной инфраструктуры, использует ли провайдер это для обучения будущих моделей, как долго это хранится и кто ещё — субподрядчики, системы логирования, живые проверяющие — может увидеть это по пути. Ничто из этого не универсально; всё зависит от продукта и провайдера, и именно поэтому стоит знать, что спрашивать.',
      sections: [
        {
          id: 'where-your-input-actually-goes',
          heading: 'Первый вопрос: уходит ли это вообще за пределы вашей инфраструктуры',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Срок хранения имеет значение только если удаление действительно происходит',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'Путь ваших данных часто включает больше сторон, чем просто ИИ-провайдер',
          paragraphs: [
      ...
      faq: [
        {
          question: 'Использует ли каждый ИИ-продукт мои беседы для обучения своих моделей?',
          answer:
        ...
        {
          question: 'Если я удалю свои данные, исчезнут ли они немедленно?',
          answer:
        ...
        {
          question: 'Что такое субподрядчики и почему они важны для приватности?',
          answer:
