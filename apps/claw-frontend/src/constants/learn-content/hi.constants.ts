  ...
  hub: {
    ...
    cardSummaries: {
      ...
      [LearnTopic.AI_DATA_PRIVACY_AND_RETENTION]:
        'AI प्रोडक्ट में आप जो टाइप करते हैं उसका असल में क्या होता है — कौन इसे देखता है, क्या यह किसी मॉडल को ट्रेन करता है, और यह कितने समय तक रहता है।',
    },
  },
  topics: {
    [LearnTopic.HOW_LANGUAGE_MODELS_GENERATE_ANSWERS]: {
    ...
    [LearnTopic.AI_DATA_PRIVACY_AND_RETENTION]: {
      seo: {
        title: 'AI डेटा प्राइवेसी और रिटेंशन, समझाया गया',
        description:
        ...
        keywords: [
          'AI डेटा प्राइवेसी समझाई गई',
          'AI डेटा रिटेंशन',
          'क्या मेरा डेटा AI ट्रेन करने में इस्तेमाल होता है',
        ],
      },
      eyebrow: 'बुनियादी बातें',
      title: 'AI डेटा प्राइवेसी और रिटेंशन, समझाया गया',
      summary:
        'AI प्रोडक्ट में आप जो टाइप करते हैं उसका क्या होता है, यह कुछ ठोस सवालों पर निर्भर करता है: क्या यह आपके ही ढाँचे से बाहर निकलता ही है, क्या कंपनी इसे भविष्य के मॉडल ट्रेन करने में इस्तेमाल करती है, इसे कितने समय स्टोर किया जाता है, और रास्ते में और कौन — सब-प्रोसेसर, लॉगिंग सिस्टम, इंसानी रिव्यूअर — इसे देख सकते हैं। इनमें से कुछ भी सार्वभौमिक नहीं है; यह प्रोडक्ट और कंपनी के हिसाब से बदलता है, और यही वजह है कि यह जानना ज़रूरी है कि क्या पूछना चाहिए।',
      sections: [
        {
          id: 'where-your-input-actually-goes',
          heading: 'पहला सवाल: क्या यह आपके ढाँचे से बाहर निकलता ही है',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'रिटेंशन अवधि तभी मायने रखती है जब डिलीट असल में होता है',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'आपके डेटा के रास्ते में अक्सर सिर्फ़ AI कंपनी से ज़्यादा पक्ष शामिल होते हैं',
          paragraphs: [
        ...
        },
        {
          ...
          heading: 'किसी भी AI टूल में कुछ संवेदनशील पेस्ट करने से पहले असल में क्या जाँचें',
          paragraphs: [
      ...
      faq: [
        {
          question: 'क्या हर AI प्रोडक्ट मेरी बातचीत अपने मॉडल ट्रेन करने में इस्तेमाल करता है?',
          answer:
        ...
        {
          question: 'अगर मैं अपना डेटा डिलीट करूँ, तो क्या वह तुरंत चला जाता है?',
          answer:
        ...
        {
          question: 'क्या लोकल AI अपने-आप क्लाउड AI प्रोडक्ट से ज़्यादा निजी होता है?',
          answer:
        ...
        {
          question: 'सब-प्रोसेसर क्या होते हैं, और वे प्राइवेसी के लिए क्यों मायने रखते हैं?',
          answer:
