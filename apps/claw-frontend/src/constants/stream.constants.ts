...
export const STREAM_STAGE_LABEL_KEYS: Readonly<Record<AiStreamStage, string>> = {
  ...
  [AiStreamStage.CRAWL_STARTED]: 'chat.stream.stage.crawlStarted',
  [AiStreamStage.CRAWL_DISCOVERING]: 'chat.stream.stage.crawlDiscovering',
  [AiStreamStage.CRAWL_READING_PAGE]: 'chat.stream.stage.crawlReadingPage',
  [AiStreamStage.CRAWL_COMPLETED]: 'chat.stream.stage.crawlCompleted',
