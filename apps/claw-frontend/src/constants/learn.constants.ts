...
export const LEARN_RELATED_PATHS: Readonly<Record<LearnTopic, ReadonlyArray<string>>> = {
  ...
  [LearnTopic.WHAT_ARE_EMBEDDINGS]: ['/features', '/use-cases', '/security-and-privacy'],
  [LearnTopic.PROMPTING_VS_RAG_VS_FINE_TUNING]: ['/features', '/use-cases', '/how-it-works'],
  [LearnTopic.HOW_AI_TOOL_CALLING_WORKS]: ['/features', '/security-and-privacy', '/how-it-works'],
  [LearnTopic.WHAT_ARE_STRUCTURED_AI_OUTPUTS]: ['/features', '/use-cases', '/how-it-works'],
  [LearnTopic.WHY_AI_HALLUCINATES]: ['/features', '/security-and-privacy', '/how-it-works'],
