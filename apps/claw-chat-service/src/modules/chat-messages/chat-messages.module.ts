...
@Module({
  ...
  providers: [ChatMessagesService, ChatExecutionManager, ContextAssemblyManager, ParallelExecutionManager, ChatStreamService, ChatMessagesRepository, ChatThreadsRepository],
