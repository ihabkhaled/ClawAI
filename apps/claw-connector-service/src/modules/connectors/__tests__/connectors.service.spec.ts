...
const mockConnectorModelsRepository = (): Partial<Record<keyof ConnectorModelsRepository, jest.Mock>> => ({
...
describe("ConnectorsService", () => {
  ...
  describe("getConnector", () => {
    ...
    it("should throw EntityNotFoundException when connector not found", async () => {
      ...
      await expect(service.getConnector("nonexistent")).rejects.toThrow(
  ...
  describe("updateConnector", () => {
    ...
    it("should throw EntityNotFoundException when connector not found", async () => {
      ...
      await expect(
        service.updateConnector("nonexistent", { name: "Updated" }),
  ...
  describe("getModels", () => {
    ...
    it("should throw EntityNotFoundException when connector not found", async () => {
      ...
      await expect(service.getModels("nonexistent")).rejects.toThrow(
        EntityNotFoundException,
      );
    });
  });
