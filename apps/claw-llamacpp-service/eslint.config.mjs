...
const banTopLevelConst = {
  selector:
    'Program > VariableDeclaration[kind="const"] > VariableDeclarator[init.type!="NewExpression"]',
  message: 'Extract top-level constants to a dedicated constants/ file.',
};
const banExportedTopLevelConst = {
  selector:
    'Program > ExportNamedDeclaration > VariableDeclaration[kind="const"] > VariableDeclarator[init.type!="NewExpression"][init.type!="ArrowFunctionExpression"]',
      ...
      'no-restricted-syntax': [
        ...
        banInlineEnum,
        {
          selector:
            'Program > VariableDeclaration[kind="const"] > VariableDeclarator[init.type!="NewExpression"]',
          message:
            'Extract top-level constants to a dedicated constants/ file. Logger instances are allowed.',
        },
        {
          selector:
            'Program > ExportNamedDeclaration > VariableDeclaration[kind="const"] > VariableDeclarator[init.type!="NewExpression"]',
          message:
            'Extract exported constants to a dedicated constants/ file. Logger instances are allowed.',
        },
      ],
    },
  },
