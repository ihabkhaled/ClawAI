...
# claw-llamacpp-service — agent guide

**Type:** nestjs-service · **Path:** `apps/claw-llamacpp-service`
...
- Port: 4017
- Database: postgresql
- Prisma models: BinaryRelease, FrontierCatalogEntry, HardwareSnapshot, ModelLoadEvent, PreflightOverrideAudit, PullJob, RuntimeConfig
...
## Before editing
1. `npm run knowledge:context -- --task="<task>" --service=llamacpp-service`
