...
```bash
docker compose -f docker-compose.dev.yml stop file-service
docker compose -f docker-compose.dev.yml rm -f file-service
docker rmi claw-file-service
docker compose -f docker-compose.dev.yml up -d --build file-service
```
