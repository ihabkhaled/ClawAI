...
@Injectable()
export class DirectLlmHandler implements IWorkflowHandler {
  readonly kind = WorkflowKind.DIRECT_LLM;
  canHandle(_c: WorkflowExecutionContext): boolean { return true; }
  plan(_c: WorkflowExecutionContext): WorkflowPlan {
    throw new Error('SCAFFOLD-R3 — DirectLlmHandler.plan not implemented');
  }
  confidence(_c: WorkflowExecutionContext): number { return 0.5; }
}
