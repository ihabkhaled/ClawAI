...
const SYSTEM_PLANS = [
  {
    ...
    // ADR-122 media gates: free keeps the basics only.
...
async function upsertSystemPlan(def) {
  ...
  return prisma.plan.upsert({
    ...
    create: {
      ...
      allowResearchMode: def.allowResearchMode,
      allowCriticReview: def.allowCriticReview,
      allowImageGeneration: def.allowImageGeneration,
