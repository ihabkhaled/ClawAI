...
export default defineConfig({
  ...
  test: {
    ...
    // vitest.setup.ts (the old jest.setup.ts) seeds the env BEFORE any module
    // whose @Cron decorators call AppConfig.get() at class-load time. Dropping
    // it is why auto-suggest-scheduler.manager.spec.ts could not even import.
