...
The packs live in `.ai/packs/*.md` (generated). The 10 canonical task kinds:
...
| **frontend-feature**        | Next.js page, component, hook, i18n                  | claw-frontend                                | 03-frontend, 04-testing | 03-feature-scaffold           | frontend reviewer, a11y              | per-folder gates on claw-frontend (+ i18n ×9)                             |
