...
apps/
  ...
  claw-<service>-service/     # 17 NestJS services (see service-catalog.md)
packages/
...
```
app/(portal)/<route>/page.tsx     # render-only pages (89 pages total)
...
lib/i18n/locales/{en,ar,de,es,fr,hi,it,pt,ru}.ts
...
| Add a frontend page        | `src/app/(portal)/<route>/page.tsx` + hook + repository + i18n ×9                                                                           |
...
- **What are all endpoints?** `.ai/manifests/api-endpoints.json` (493 endpoints).
