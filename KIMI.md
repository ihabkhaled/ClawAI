...
Compact router for Kimi. This file does not duplicate policy — it routes you
...
- You have a large context window — still use the task-context resolver instead
  of ingesting the repository indiscriminately. Load `.ai/local/current-context.md`,
  not the whole tree. Breadth without focus produces ungrounded edits.
