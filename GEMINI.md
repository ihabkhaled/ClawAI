...
Compact router for Gemini. This file does not duplicate policy — it routes you
...
- Preserve canonical authority and repository-grounded facts. When you state a
  port/event/route, cite the manifest it came from (`.ai/manifests/*`). Do not
  paraphrase policy from memory — link the canonical rule.
